...
.method private synthetic a(Lcom/google/firebase/firestore/util/Consumer;Landroid/database/Cursor;)V
    .locals 1
...
.method static synthetic c(Lcom/google/firebase/firestore/local/SQLiteTargetCache$DocumentKeysHolder;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic d(Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic f(Landroid/util/SparseArray;[ILandroid/database/Cursor;)V
    .locals 1
...
.method public synthetic b(Lcom/google/firebase/firestore/util/Consumer;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/firestore/local/SQLiteTargetCache;->a(Lcom/google/firebase/firestore/util/Consumer;Landroid/database/Cursor;)V
...
.method public synthetic e(Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/firestore/local/SQLiteTargetCache;->d(Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;Landroid/database/Cursor;)V
...
.method public forEachTarget(Lcom/google/firebase/firestore/util/Consumer;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/google/firebase/firestore/local/x1;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Lcom/google/firebase/firestore/util/Consumer;)V
...
.method public synthetic g(Landroid/util/SparseArray;[ILandroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/firestore/local/SQLiteTargetCache;->f(Landroid/util/SparseArray;[ILandroid/database/Cursor;)V
...
.method public getMatchingKeysForTargetId(I)Lcom/google/firebase/database/collection/ImmutableSortedSet;
    ...
    invoke-direct {v1, v0}, Lcom/google/firebase/firestore/local/v1;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache$DocumentKeysHolder;)V
...
.method public getTargetData(Lcom/google/firebase/firestore/core/Target;)Lcom/google/firebase/firestore/local/TargetData;
    ...
    new-instance v2, Lcom/google/firebase/firestore/local/w1;

    invoke-direct {v2, p0, p1, v1}, Lcom/google/firebase/firestore/local/w1;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Lcom/google/firebase/firestore/core/Target;Lcom/google/firebase/firestore/local/SQLiteTargetCache$TargetDataHolder;)V
...
.method public synthetic i(Landroid/database/Cursor;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/firebase/firestore/local/SQLiteTargetCache;->h(Landroid/database/Cursor;)V
...
.method removeQueries(JLandroid/util/SparseArray;)I
    ...
    new-instance v0, Lcom/google/firebase/firestore/local/y1;

    invoke-direct {v0, p0, p3, v1}, Lcom/google/firebase/firestore/local/y1;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;Landroid/util/SparseArray;[I)V
...
.method start()V
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/firestore/local/z1;-><init>(Lcom/google/firebase/firestore/local/SQLiteTargetCache;)V
