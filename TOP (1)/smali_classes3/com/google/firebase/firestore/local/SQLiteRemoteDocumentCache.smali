...
.method private synthetic a(Landroid/database/Cursor;)Lcom/google/firebase/firestore/model/MutableDocument;
    .locals 1
...
.method private synthetic c(Ljava/util/Map;Landroid/database/Cursor;)V
    .locals 1
...
.method private synthetic e([BLcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;)V
    .locals 2
...
.method private synthetic g(ILcom/google/firebase/firestore/util/BackgroundQueue;Lcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;Landroid/database/Cursor;)V
    .locals 1
    ...
    .line 5
    :cond_1
    new-instance p5, Lcom/google/firebase/firestore/local/d1;

    invoke-direct {p5, p0, p1, p3, p4}, Lcom/google/firebase/firestore/local/d1;-><init>(Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;[BLcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;)V
...
.method public synthetic b(Landroid/database/Cursor;)Lcom/google/firebase/firestore/model/MutableDocument;
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;->a(Landroid/database/Cursor;)Lcom/google/firebase/firestore/model/MutableDocument;
...
.method public synthetic d(Ljava/util/Map;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;->c(Ljava/util/Map;Landroid/database/Cursor;)V

    return-void
.end method

.method public synthetic f([BLcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;->e([BLcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;)V
...
.method public get(Lcom/google/firebase/firestore/model/DocumentKey;)Lcom/google/firebase/firestore/model/MutableDocument;
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/firestore/local/b1;-><init>(Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;)V
...
.method public getAll(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    new-instance v2, Lcom/google/firebase/firestore/local/c1;

    invoke-direct {v2, p0, v1}, Lcom/google/firebase/firestore/local/c1;-><init>(Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;Ljava/util/Map;)V
...
.method public getAllDocumentsMatchingQuery(Lcom/google/firebase/firestore/core/Query;Lcom/google/firebase/firestore/model/SnapshotVersion;)Lcom/google/firebase/database/collection/ImmutableSortedMap;
    ...
    new-array v11, v1, [Lcom/google/firebase/database/collection/ImmutableSortedMap;
    ...
    invoke-virtual {p2, v5}, Lcom/google/firebase/firestore/model/SnapshotVersion;->equals(Ljava/lang/Object;)Z
    ...
    .line 12
    invoke-virtual {p2, v4}, Lcom/google/firebase/firestore/local/SQLitePersistence;->query(Ljava/lang/String;)Lcom/google/firebase/firestore/local/SQLitePersistence$Query;
    ...
    .line 13
    invoke-virtual {p2, v4}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->binding([Ljava/lang/Object;)Lcom/google/firebase/firestore/local/SQLitePersistence$Query;
    ...
    .line 15
    invoke-virtual {p2, v7}, Lcom/google/firebase/firestore/local/SQLitePersistence;->query(Ljava/lang/String;)Lcom/google/firebase/firestore/local/SQLitePersistence$Query;
    ...
    .line 19
    invoke-virtual {p2, v7}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->binding([Ljava/lang/Object;)Lcom/google/firebase/firestore/local/SQLitePersistence$Query;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/google/firebase/firestore/local/e1;-><init>(Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;ILcom/google/firebase/firestore/util/BackgroundQueue;Lcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;)V

    invoke-virtual {p2, v0}, Lcom/google/firebase/firestore/local/SQLitePersistence$Query;->forEach(Lcom/google/firebase/firestore/util/Consumer;)I
...
.method public synthetic h(ILcom/google/firebase/firestore/util/BackgroundQueue;Lcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;Landroid/database/Cursor;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lcom/google/firebase/firestore/local/SQLiteRemoteDocumentCache;->g(ILcom/google/firebase/firestore/util/BackgroundQueue;Lcom/google/firebase/firestore/core/Query;[Lcom/google/firebase/database/collection/ImmutableSortedMap;Landroid/database/Cursor;)V
