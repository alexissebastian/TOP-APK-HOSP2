...
.method private synthetic a(Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
    .locals 6
...
.method private synthetic c(Ljava/util/List;Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public static isMissingSslCiphers(Lio/grpc/h1;)Z
    .locals 5

    .line 1
    invoke-virtual {p0}, Lio/grpc/h1;->n()Lio/grpc/h1$b;

    move-result-object v0

    .line 2
    invoke-virtual {p0}, Lio/grpc/h1;->m()Ljava/lang/Throwable;
    ...
    sget-object v1, Lio/grpc/h1$b;->L0:Lio/grpc/h1$b;
...
.method public static isPermanentError(Lio/grpc/h1;)Z
    .locals 0
    ...
    invoke-virtual {p0}, Lio/grpc/h1$b;->c()I
...
.method public static isPermanentWriteError(Lio/grpc/h1;)Z
    .locals 1

    .line 1
    invoke-static {p0}, Lcom/google/firebase/firestore/remote/Datastore;->isPermanentError(Lio/grpc/h1;)Z
...
# virtual methods
.method public synthetic b(Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/firebase/firestore/remote/Datastore;->a(Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
...
.method public commit(Ljava/util/List;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {p1, v1, v0}, Lcom/google/firebase/firestore/remote/FirestoreChannel;->runRpc(Lio/grpc/u0;Ljava/lang/Object;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-direct {v1, p0}, Lcom/google/firebase/firestore/remote/i;-><init>(Lcom/google/firebase/firestore/remote/Datastore;)V
...
.method public synthetic d(Ljava/util/List;Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/firebase/firestore/remote/Datastore;->c(Ljava/util/List;Lcom/google/android/gms/tasks/Task;)Ljava/util/List;
...
.method public lookup(Ljava/util/List;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-virtual {v1, v2, v0}, Lcom/google/firebase/firestore/remote/FirestoreChannel;->runStreamingResponseRpc(Lio/grpc/u0;Ljava/lang/Object;)Lcom/google/android/gms/tasks/Task;
    ...
    new-instance v2, Lcom/google/firebase/firestore/remote/j;

    invoke-direct {v2, p0, p1}, Lcom/google/firebase/firestore/remote/j;-><init>(Lcom/google/firebase/firestore/remote/Datastore;Ljava/util/List;)V
