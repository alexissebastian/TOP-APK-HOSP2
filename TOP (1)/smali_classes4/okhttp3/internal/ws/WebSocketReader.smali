...
.method public constructor <init>(ZLokio/g;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
    ...
    :goto_1
    iput-object p2, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/Buffer$a;
...
.method private final readControlFrame()V
    ...
    invoke-interface {v4, v5, v0, v1}, Lokio/g;->m(Lokio/Buffer;J)V
    ...
    iget-object v1, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/Buffer$a;

    invoke-static {v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    invoke-virtual {v0, v1}, Lokio/Buffer;->j0(Lokio/Buffer$a;)Lokio/Buffer$a;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketReader;->maskCursor:Lokio/Buffer$a;

    invoke-virtual {v0, v2, v3}, Lokio/Buffer$a;->d(J)I
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/Buffer$a;[B)V
...
.method private final readHeader()V
    ...
    invoke-interface {v2}, Lokio/Source;->timeout()Lokio/c0;

    move-result-object v2

    invoke-virtual {v2}, Lokio/c0;->clearTimeout()Lokio/c0;
    ...
    invoke-interface {v4}, Lokio/Source;->timeout()Lokio/c0;

    move-result-object v4

    sget-object v5, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v4, v0, v1, v5}, Lokio/c0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/c0;
    ...
    invoke-interface {v3}, Lokio/Source;->timeout()Lokio/c0;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lokio/c0;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/c0;
...
.method private final readMessage()V
    ...
    invoke-interface {v2, v3, v0, v1}, Lokio/g;->m(Lokio/Buffer;J)V
    ...
    invoke-virtual {v0, v1, v2}, Lokio/Buffer$a;->d(J)I
    ...
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketProtocol;->toggleMask(Lokio/Buffer$a;[B)V
