...
.method public final acceptHeader(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lokio/ByteString;->H()Lokio/ByteString;
...
.method public final toggleMask(Lokio/Buffer$a;[B)V
    .locals 7
    ...
    .line 2
    :cond_0
    iget-object v2, p1, Lokio/Buffer$a;->z0:[B

    .line 3
    iget v3, p1, Lokio/Buffer$a;->A0:I

    .line 4
    iget v4, p1, Lokio/Buffer$a;->B0:I
    ...
    .line 9
    :cond_1
    invoke-virtual {p1}, Lokio/Buffer$a;->a()I
