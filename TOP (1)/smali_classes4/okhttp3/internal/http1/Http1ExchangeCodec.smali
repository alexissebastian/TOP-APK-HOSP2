...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;Lokio/k;)V
    .locals 0
...
.method private final detachTimeout(Lokio/k;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lokio/k;->a()Lokio/c0;

    move-result-object v0

    .line 2
    sget-object v1, Lokio/c0;->NONE:Lokio/c0;

    invoke-virtual {p1, v1}, Lokio/k;->b(Lokio/c0;)Lokio/k;
...
.method private final newChunkedSink()Lokio/a0;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/a0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/a0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()Lokio/a0;
    ...
    .line 3
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()Lokio/a0;
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;
    ...
    .line 4
    iget-object v3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lokio/f;
