...
.method public constructor <init>(Lokio/Source;)V
    ...
    .line 3
    invoke-interface {v0}, Lokio/g;->A()Ljava/lang/String;
...
.method private final readCertificateList(Lokio/g;)Ljava/util/List;
    ...
    .line 5
    invoke-interface {p1}, Lokio/g;->A()Ljava/lang/String;
    ...
    .line 7
    sget-object v6, Lokio/ByteString;->z0:Lokio/ByteString$a;
    ...
    invoke-virtual {v5, v4}, Lokio/Buffer;->v0(Lokio/ByteString;)Lokio/Buffer;

    .line 8
    invoke-virtual {v5}, Lokio/Buffer;->Y()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/f;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/f;->F(J)Lokio/f;
    ...
    .line 4
    sget-object v4, Lokio/ByteString;->z0:Lokio/ByteString$a;
    ...
    .line 5
    invoke-interface {p1, v3}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 1
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Lokio/a0;
    ...
    invoke-interface {p1, v3, v4}, Lokio/f;->F(J)Lokio/f;
    ...
    invoke-interface {p1, v5}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v4, v5}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;

    move-result-object v4

    .line 9
    invoke-interface {v4, v2}, Lokio/f;->writeByte(I)Lokio/f;
    ...
    invoke-interface {p1, v5, v6}, Lokio/f;->F(J)Lokio/f;
    ...
    .line 14
    invoke-interface {v3, v4}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;
    ...
    .line 16
    invoke-interface {v3, v2}, Lokio/f;->writeByte(I)Lokio/f;
    ...
    invoke-interface {p1, v0}, Lokio/f;->r(Ljava/lang/String;)Lokio/f;
    ...
    invoke-interface {v0, v5, v6}, Lokio/f;->F(J)Lokio/f;
    ...
    invoke-interface {v0, v3, v4}, Lokio/f;->F(J)Lokio/f;
