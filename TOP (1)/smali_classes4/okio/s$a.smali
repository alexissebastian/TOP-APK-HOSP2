...
.method private final a(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    .line 7
    :goto_3
    invoke-virtual {v3, v11}, Lokio/ByteString;->t(I)B

    move-result v5

    invoke-virtual {v4, v11}, Lokio/ByteString;->t(I)B
    ...
    .line 9
    :cond_6
    invoke-direct {v9, v10}, Lokio/s$a;->c(Lokio/Buffer;)J
    ...
    invoke-virtual {v1, v11}, Lokio/ByteString;->t(I)B
    ...
    invoke-virtual {v2, v11}, Lokio/ByteString;->t(I)B
    ...
    invoke-virtual {v0, v11}, Lokio/ByteString;->t(I)B
    ...
    .line 20
    :cond_c
    invoke-direct {v9, v8}, Lokio/s$a;->c(Lokio/Buffer;)J
    ...
    .line 21
    invoke-direct/range {v0 .. v8}, Lokio/s$a;->a(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    .line 22
    invoke-virtual {v10, v15}, Lokio/Buffer;->w(Lokio/Source;)J
    ...
    .line 24
    invoke-virtual {v3, v7}, Lokio/ByteString;->t(I)B

    move-result v1

    invoke-virtual {v4, v7}, Lokio/ByteString;->t(I)B
    ...
    .line 33
    invoke-direct {v9, v11}, Lokio/s$a;->c(Lokio/Buffer;)J
    ...
    .line 35
    invoke-virtual {v10, v11}, Lokio/Buffer;->w(Lokio/Source;)J
...
.method static synthetic b(Lokio/s$a;JLokio/Buffer;ILjava/util/List;IILjava/util/List;ILjava/lang/Object;)V
    .locals 11
    ...
    invoke-direct/range {v2 .. v10}, Lokio/s$a;->a(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
...
# virtual methods
.method public final varargs d([Lokio/ByteString;)Lokio/s;
    .locals 16
    ...
    invoke-direct {v0, v1, v2, v4}, Lokio/s;-><init>([Lokio/ByteString;[ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 25
    invoke-static/range {v5 .. v15}, Lokio/s$a;->b(Lokio/s$a;JLokio/Buffer;ILjava/util/List;IILjava/util/List;ILjava/lang/Object;)V

    move-object/from16 v1, p0

    .line 26
    invoke-direct {v1, v2}, Lokio/s$a;->c(Lokio/Buffer;)J
    ...
    invoke-direct {v2, v0, v5, v4}, Lokio/s;-><init>([Lokio/ByteString;[ILkotlin/jvm/internal/DefaultConstructorMarker;)V
