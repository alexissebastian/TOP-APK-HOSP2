...
.method constructor <init>(Lorg/reactnative/camera/CameraModule;ILcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/Promise;Ljava/io/File;)V
    ...
    iput-object p3, p0, Lorg/reactnative/camera/CameraModule$k;->b:Lcom/facebook/react/bridge/ReadableMap;

    iput-object p4, p0, Lorg/reactnative/camera/CameraModule$k;->c:Lcom/facebook/react/bridge/Promise;

    iput-object p5, p0, Lorg/reactnative/camera/CameraModule$k;->d:Ljava/io/File;
...
.method public execute(Lcom/facebook/react/uimanager/m;)V
    ...
    .line 3
    iget-object v0, p0, Lorg/reactnative/camera/CameraModule$k;->b:Lcom/facebook/react/bridge/ReadableMap;

    iget-object v1, p0, Lorg/reactnative/camera/CameraModule$k;->c:Lcom/facebook/react/bridge/Promise;

    iget-object v2, p0, Lorg/reactnative/camera/CameraModule$k;->d:Ljava/io/File;

    invoke-virtual {p1, v0, v1, v2}, Lorg/reactnative/camera/d;->W(Lcom/facebook/react/bridge/ReadableMap;Lcom/facebook/react/bridge/Promise;Ljava/io/File;)V

    goto :goto_0

    .line 4
    :cond_0
    iget-object p1, p0, Lorg/reactnative/camera/CameraModule$k;->c:Lcom/facebook/react/bridge/Promise;
    ...
    .line 5
    iget-object v0, p0, Lorg/reactnative/camera/CameraModule$k;->c:Lcom/facebook/react/bridge/Promise;
