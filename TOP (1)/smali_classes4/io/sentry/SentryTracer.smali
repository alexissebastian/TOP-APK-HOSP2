...
.method constructor <init>(Lio/sentry/TransactionContext;Lio/sentry/IHub;Ljava/util/Date;ZLio/sentry/TransactionFinishedCallback;)V
    .locals 1
    .param p1    # Lio/sentry/TransactionContext;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method private synthetic a(Lio/sentry/Span;)V
    .locals 1
...
.method private synthetic c(Lio/sentry/Scope;Lio/sentry/ITransaction;)V
    .locals 0
...
.method private createChild(Lio/sentry/SpanId;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lio/sentry/ISpan;
    ...
    invoke-direct {v8, p0}, Lio/sentry/z;-><init>(Lio/sentry/SentryTracer;)V
...
.method private synthetic e(Lio/sentry/Scope;)V
    .locals 1

    .line 1
    new-instance v0, Lio/sentry/x;

    invoke-direct {v0, p0, p1}, Lio/sentry/x;-><init>(Lio/sentry/SentryTracer;Lio/sentry/Scope;)V
...
.method static synthetic g(Ljava/util/concurrent/atomic/AtomicReference;Lio/sentry/Scope;)V
    .locals 0
...
# virtual methods
.method public synthetic b(Lio/sentry/Span;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/sentry/SentryTracer;->a(Lio/sentry/Span;)V

    return-void
.end method

.method public synthetic d(Lio/sentry/Scope;Lio/sentry/ITransaction;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lio/sentry/SentryTracer;->c(Lio/sentry/Scope;Lio/sentry/ITransaction;)V

    return-void
.end method

.method public synthetic f(Lio/sentry/Scope;)V
    .locals 0

    invoke-direct {p0, p1}, Lio/sentry/SentryTracer;->e(Lio/sentry/Scope;)V
...
.method public finish(Lio/sentry/SpanStatus;)V
    ...
    invoke-direct {v0, p0}, Lio/sentry/y;-><init>(Lio/sentry/SentryTracer;)V
...
.method startChild(Lio/sentry/SpanId;Ljava/lang/String;Ljava/lang/String;Ljava/util/Date;)Lio/sentry/ISpan;
    .locals 0
    .param p1    # Lio/sentry/SpanId;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public traceState()Lio/sentry/TraceState;
    ...
    invoke-direct {v2, v0}, Lio/sentry/w;-><init>(Ljava/util/concurrent/atomic/AtomicReference;)V
