...
public class b implements atd.ba.h {
    ...
    protected long[] f12257a = new long[25];
    protected byte[] b = new byte[192];
    protected int c;

    /* renamed from: d  reason: collision with root package name */
    protected int f12258d;
    protected int e;
    protected boolean f;
    ...
    private void b(int i) {
        ...
        int i2 = 0;
        while (true) {
            long[] jArr = this.f12257a;
            if (i2 >= jArr.length) {
                atd.ce.a.a(this.b, (byte) 0);
                this.f12258d = 0;
                this.f = false;
                this.e = (1600 - i) / 2;
                return;
    ...
    private void b(byte[] bArr, int i) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            long[] jArr = this.f12257a;
            jArr[i3] = jArr[i3] ^ atd.ce.e.e(bArr, i);
            i += 8;
        }
        f();
    }
    ...
    private void d() {
        ...
        for (int i8 = 0; i8 < i5; i8++) {
            long[] jArr = this.f12257a;
            jArr[i8] = jArr[i8] ^ atd.ce.e.e(this.b, i7);
            i7 += 8;
        }
        if (i6 > 0) {
            long[] jArr2 = this.f12257a;
            jArr2[i5] = jArr2[i5] ^ (atd.ce.e.e(this.b, i7) & ((1 << i6) - 1));
        }
        long[] jArr3 = this.f12257a;
        int i9 = (this.c - 1) >> 6;
    ...
    private void e() {
        atd.ce.e.a(this.f12257a, 0, this.c >> 6, this.b, 0);
    }
    ...
    public void a(byte[] bArr, int i, long j) {
        ...
        while (j2 < j) {
            ...
            int min = (int) Math.min(this.f12258d, j - j2);
            System.arraycopy(this.b, (this.c - this.f12258d) / 8, bArr, ((int) (j2 / 8)) + i, min / 8);
            this.f12258d -= min;
            j2 += min;
        }
    }
