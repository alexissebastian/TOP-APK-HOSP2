...
public final class a {
    ...
    private final UiCustomization f12146a;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: atd.an.a$1  reason: invalid class name */
    /* loaded from: classes.dex */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] iArr = new int[DividerView.a.values().length];
            f12147a = iArr;
            try {
                iArr[DividerView.a.HORIZONTAL.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f12147a[DividerView.a.VERTICAL.ordinal()] = 2;
    ...
    public void a(Window window) {
        ...
        UiCustomization uiCustomization = this.f12146a;
        ...
        if (i < 21 || (parseHexColorCode = Customization.parseHexColorCode(screenCustomization.getStatusBarColor())) == null) {
            return;
        }
            ...
            if (drawable instanceof InsetDrawable) {
                ...
                if (drawableContainerState != null) {
                    for (int i2 = 0; i2 < drawableContainerState.getChildren().length; i2++) {
                        b(drawableContainerState.getChild(i2), num);
                    }
                }
    ...
    private void a(ProgressBar progressBar, int i) {
        ...
        Integer parseHexColorCode;
        if (i != R.style.Widget_ThreeDS2_ProgressBar || (toolbarCustomization = this.f12146a.getToolbarCustomization()) == null || (parseHexColorCode = Customization.parseHexColorCode(toolbarCustomization.getBackgroundColor())) == null) {
            return;
        }
    ...
    private void a(CompoundButton compoundButton) {
        Integer parseHexColorCode;
        SelectionItemCustomization selectionItemCustomization = this.f12146a.getSelectionItemCustomization();
    ...
    private void a(Button button, int i) {
        if (i == R.style.Widget_ThreeDS2_Button_Borderless_Cancel) {
            b(button, this.f12146a.getButtonCustomization(UiCustomization.ButtonType.CANCEL));
        } else if (i == R.style.Widget_ThreeDS2_Button_Borderless_Resend) {
            b(button, this.f12146a.getButtonCustomization(UiCustomization.ButtonType.RESEND));
        } else if (i == R.style.Widget_ThreeDS2_Button_Colored_Verify) {
            a(button, this.f12146a.getButtonCustomization(UiCustomization.ButtonType.VERIFY));
        } else if (i == R.style.Widget_ThreeDS2_Button_Colored_Continue) {
            a(button, this.f12146a.getButtonCustomization(UiCustomization.ButtonType.CONTINUE));
        } else if (i == R.style.Widget_ThreeDS2_Button_Colored_Next) {
            a(button, this.f12146a.getButtonCustomization(UiCustomization.ButtonType.NEXT));
        }
    }
    ...
    private void a(EditText editText) {
        TextBoxCustomization textBoxCustomization = this.f12146a.getTextBoxCustomization();
    ...
    private void a(TextView textView, int i) {
        if (i == R.style.TextAppearance_ThreeDS2_Widget_Toolbar_Title) {
            a(textView, this.f12146a.getToolbarCustomization());
        } else if (i == R.style.TextAppearance_ThreeDS2_Heading) {
            LabelCustomization labelCustomization = this.f12146a.getLabelCustomization();
            ...
            LabelCustomization labelCustomization2 = this.f12146a.getLabelCustomization();
            ...
            a(textView, this.f12146a.getSelectionItemCustomization());
        } else if (i == R.style.TextAppearance_ThreeDS2_Widget_ExpandableInfoText_Title) {
            ExpandableInfoCustomization expandableInfoCustomization = this.f12146a.getExpandableInfoCustomization();
            ...
            a(textView, this.f12146a.getExpandableInfoCustomization());
        } else {
            a(textView, this.f12146a.getLabelCustomization());
        }
    }
    ...
    private void a(ToolbarView toolbarView) {
        ToolbarCustomization toolbarCustomization = this.f12146a.getToolbarCustomization();
    ...
    private void a(View view, int i) {
        ...
        Integer parseHexColorCode;
        if (i != R.style.Widget_ThreeDS2_SelectItem || (selectionItemCustomization = this.f12146a.getSelectionItemCustomization()) == null || (parseHexColorCode = Customization.parseHexColorCode(selectionItemCustomization.getHighlightedBackgroundColor())) == null) {
            return;
        }
    ...
    private void a(DividerView dividerView) {
        ...
        if (id == R.id.dividerView_info) {
            ExpandableInfoCustomization expandableInfoCustomization2 = this.f12146a.getExpandableInfoCustomization();
        ...
        } else if (id != R.id.dividerView_logos || (expandableInfoCustomization = this.f12146a.getExpandableInfoCustomization()) == null) {
        } else {
    ...
    private void a(DividerView dividerView, String str, int i) {
        ...
        if (i >= 0) {
            int i2 = AnonymousClass1.f12147a[dividerView.getOrientation().ordinal()];
            if (i2 == 1) {
