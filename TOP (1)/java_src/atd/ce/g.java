...
public final class g {
    ...
    private static String f12409a;

    static {
        try {
            try {
                f12409a = (String) AccessController.doPrivileged(new PrivilegedAction<String>() { // from class: atd.ce.g.1
                ...
                f12409a = String.format("%n", new Object[0]);
            }
    ...
    public static String a(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            if ((bArr[i2] & 240) == 240) {
                ...
                c = (char) (((bArr[i2] & Ascii.SI) << 12) | ((bArr[i2 + 1] & 63) << 6) | (bArr[i2 + 2] & 63));
                i2 += 3;
            } else {
                if ((bArr[i2] & 208) == 208) {
