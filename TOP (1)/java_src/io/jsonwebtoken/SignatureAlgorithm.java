...
public enum SignatureAlgorithm {
    ...
    HS384("HS384", "HMAC using SHA-384", "HMAC", "HmacSHA384", true, Function.USE_VARARGS, Function.USE_VARARGS, "1.2.840.113549.2.10"),
    ...
    RS384("RS384", "RSASSA-PKCS-v1_5 using SHA-384", "RSA", "SHA384withRSA", true, Function.USE_VARARGS, 2048),
    ...
    ES384("ES384", "ECDSA using P-384 and SHA-384", "ECDSA", "SHA384withECDSA", true, Function.USE_VARARGS, Function.USE_VARARGS),
    ...
    PS384("PS384", "RSASSA-PSS using SHA-384 and MGF1 with SHA-384", "RSA", "RSASSA-PSS", false, Function.USE_VARARGS, 2048),
