...
public final class SentryClient implements ISentryClient {
    ...
    public SentryClient(@NotNull SentryOptions sentryOptions) {
        ...
        this.random = sentryOptions.getSampleRate() != null ? new Random() : null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: a */
    public /* synthetic */ void b(SentryEvent sentryEvent, Object obj, Session session) {
        boolean z = false;
        if (session != null) {
            String str = null;
    ...
    @Nullable
    private SentryEnvelope buildEnvelope(@Nullable SentryBaseEvent sentryBaseEvent, @Nullable List<Attachment> list, @Nullable Session session, @Nullable TraceState traceState) throws IOException {
        SentryId sentryId;
    ...
    private SentryTransaction processTransaction(@NotNull SentryTransaction sentryTransaction, @Nullable Object obj, @NotNull List<EventProcessor> list) {
        ...
        while (true) {
            ...
            try {
                ...
                this.options.getLogger().log(SentryLevel.ERROR, e, "An exception occurred while processing transaction by processor: %s", next.getClass().getName());
                continue;
            }
    ...
    @Nullable
    Session updateSessionData(@NotNull final SentryEvent sentryEvent, @Nullable final Object obj, @Nullable Scope scope) {
        if (ApplyScopeUtils.shouldApplyScopeData(obj)) {
            if (scope != null) {
                return scope.withSession(new Scope.IWithSession() { // from class: io.sentry.j
                    @Override // io.sentry.Scope.IWithSession
                    public final void accept(Session session) {
                        SentryClient.this.b(sentryEvent, obj, session);
                    }
                });
            }
    ...
    @NotNull
    private <T extends SentryBaseEvent> T applyScope(@NotNull T t, @Nullable Scope scope) {
        if (scope != null) {
