...
final class ManifestMetadataReader {
        ...
        try {
            ...
            if (metadata != null) {
                ...
                if (sentryAndroidOptions.isDebug()) {
                    ...
                    String readString = readString(metadata, logger, DEBUG_LEVEL, name.toLowerCase(locale));
                    if (readString != null) {
                        sentryAndroidOptions.setDiagnosticLevel(SentryLevel.valueOf(readString.toUpperCase(locale)));
                    }
                }
    ...
    private static boolean readBool(@NotNull Bundle bundle, @NotNull ILogger iLogger, @NotNull String str, boolean z) {
    ...
    private static long readLong(@NotNull Bundle bundle, @NotNull ILogger iLogger, @NotNull String str, long j) {
