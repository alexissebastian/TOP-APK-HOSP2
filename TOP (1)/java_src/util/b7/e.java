...
public class e extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_CELL), "Alpha Channels");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_CROSSHAIR), "Display Info (Obsolete)");
        hashMap.put(1008, "Caption");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_VERTICAL_TEXT), "Border Information");
        hashMap.put(1010, "Background Color");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_COPY), "Print Flags");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_NO_DROP), "Grayscale and Multichannel Halftoning Information");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_ALL_SCROLL), "Color Halftoning Information");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_HORIZONTAL_DOUBLE_ARROW), "Duotone Halftoning Information");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_VERTICAL_DOUBLE_ARROW), "Grayscale and Multichannel Transfer Function");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_TOP_RIGHT_DIAGONAL_DOUBLE_ARROW), "Color Transfer Functions");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_TOP_LEFT_DIAGONAL_DOUBLE_ARROW), "Duotone Transfer Functions");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_ZOOM_IN), "Duotone Image Information");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_ZOOM_OUT), "Effective Black and White Values");
        hashMap.put(Integer.valueOf((int) PointerIconCompat.TYPE_GRABBING), "EPS Options");
        ...
        hashMap.put(Integer.valueOf((int) ClientProto.OAUTH_SCOPES_FIELD_NUMBER), "Slices");
        hashMap.put(Integer.valueOf((int) ClientProto.METHOD_SIGNATURE_FIELD_NUMBER), "Workflow URL");
        hashMap.put(Integer.valueOf((int) FieldBehaviorProto.FIELD_BEHAVIOR_FIELD_NUMBER), "Jump To XPEP");
