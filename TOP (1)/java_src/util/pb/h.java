...
class h {
    ...
    private static final h f15688d = new h();

    /* renamed from: a  reason: collision with root package name */
    private final a f15689a = new a();
    ...
    private void a(int i, int i2, byte b2) {
        a aVar = new a(i, b2);
        a aVar2 = this.f15689a;
        while (b2 > 8) {
            b2 = (byte) (b2 - 8);
            int i3 = (i2 >>> b2) & 255;
            if (aVar2.f15690a != null) {
                if (aVar2.f15690a[i3] == null) {
                    aVar2.f15690a[i3] = new a();
                }
                aVar2 = aVar2.f15690a[i3];
            } else {
    ...
    public byte[] c(byte[] bArr) throws IOException {
        ...
        for (byte b2 : bArr) {
            ...
            i2 += 8;
            while (i2 >= 8) {
                aVar = aVar.f15690a[(i >>> (i2 - 8)) & 255];
                if (aVar.f15690a == null) {
        ...
        while (i2 > 0) {
            a aVar2 = aVar.f15690a[(i << (8 - i2)) & 255];
            if (aVar2.f15690a != null || aVar2.c > i2) {
                break;
            }
