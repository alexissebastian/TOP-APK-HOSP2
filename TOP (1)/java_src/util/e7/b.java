...
public class b extends com.drew.metadata.b {
    ...
    protected static final transient HashMap<String, Integer> f;
    protected static final transient HashMap<Integer, String> g;
    ...
    static {
        ...
        hashMap3.put(Integer.valueOf((int) Function.USE_VARARGS), "Fraunhofer IIS MPEG2AAC");
        hashMap3.put(Integer.valueOf((int) LogSeverity.WARNING_VALUE), "Digital Theater Systems DTS DS");
        ...
        hashMap3.put(Integer.valueOf((int) TypedValues.MotionType.TYPE_DRAW_PATH), "Consistent CS2");
        ...
        hashMap3.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_GAMEPAD), "Intel Music Coder (IMC)");
        ...
        hashMap3.put(Integer.valueOf((int) FragmentTransaction.TRANSIT_FRAGMENT_OPEN), "Olivetti ADPCM");
        hashMap3.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_TOUCHSCREEN), "Olivetti CELP");
        hashMap3.put(Integer.valueOf((int) FragmentTransaction.TRANSIT_FRAGMENT_FADE), "Olivetti SBC");
        hashMap3.put(Integer.valueOf((int) CapResultCode.TOKEN_WRAPPED_COUNTER), "Olivetti OPR");
