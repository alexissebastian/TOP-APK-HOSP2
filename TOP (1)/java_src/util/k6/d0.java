...
public class d0 extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) Constants.LANDSCAPE_270), "WB RB Levels CWB1");
        ...
        hashMap.put(Integer.valueOf((int) ModuleDescriptor.MODULE_VERSION), "WB G Level 4000K");
