...
public class f0 extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_DPAD), "JPEG Quality");
        ...
        hashMap.put(Integer.valueOf((int) FragmentTransaction.TRANSIT_FRAGMENT_OPEN), "ISO Value");
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_TOUCHSCREEN), "Aperture Value");
        hashMap.put(Integer.valueOf((int) FragmentTransaction.TRANSIT_FRAGMENT_FADE), "Brightness Value");
        hashMap.put(Integer.valueOf((int) CapResultCode.TOKEN_WRAPPED_COUNTER), "Flash Mode");
        ...
        hashMap.put(4111, ExifInterface.TAG_SHARPNESS);
        ...
        hashMap.put(4137, ExifInterface.TAG_CONTRAST);
        ...
        hashMap.put(61462, HttpHeaders.DATE);
        ...
        hashMap.put(61472, ExifInterface.TAG_SATURATION);
        hashMap.put(61473, ExifInterface.TAG_CONTRAST);
        hashMap.put(61474, ExifInterface.TAG_SHARPNESS);
