...
public class w0 extends com.drew.metadata.h<x0> {
    public w0(x0 x0Var) {
        super(x0Var);
    }
    ...
    public String w() {
        Integer l = ((x0) this.f13435a).l(2);
        if (l == null) {
            return null;
        }
        int intValue = l.intValue();
        return intValue != 4096 ? intValue != 8192 ? intValue != 12288 ? intValue != 73728 ? intValue != 3145728 ? String.format("Unknown (%d)", l) : "SMX Video Camera" : "Cell Phone" : "HXM Video Camera" : "High-end NX Camera" : "Compact Digital Camera";
    }
