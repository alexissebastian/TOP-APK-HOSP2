...
public class y extends com.drew.metadata.h<z> {
    ...
    private static double v(int i) {
        return Math.pow(Math.sqrt(2.0d), i / 256.0d);
    }

    public String A() {
        return m(FragmentTransaction.TRANSIT_FRAGMENT_OPEN, "None", "FL-20", "FL-50", "RF-11", "TF-22", "FL-36", "FL-50R", "FL-36R");
    }
    ...
    public String C() {
        return ((z) this.f13435a).r(259) + " mm";
    }

    public String D() {
        Integer l = ((z) this.f13435a).l(516);
        if (l == null) {
            return null;
        }
        String format = String.format("%04X", l);
        return String.format("%s.%s", format.substring(0, format.length() - 3), format.substring(format.length() - 3));
    }

    public String E() {
        Integer l = ((z) this.f13435a).l(523);
        if (l == null) {
            return null;
        }
        return String.format("0x%04X", l);
    }

    public String F() {
        String r = ((z) this.f13435a).r(InputDeviceCompat.SOURCE_DPAD);
        if (r == null) {
            return null;
        }
        ...
        try {
            return b.get(String.format("%X %02X %02X", Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2])), Integer.valueOf(Integer.parseInt(split[3]))));
    ...
    public String G() {
        Integer l = ((z) this.f13435a).l(518);
        if (l == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(v(l.intValue()));
    }

    public String H() {
        Integer l = ((z) this.f13435a).l(517);
        if (l == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(v(l.intValue()));
    ...
    public String I() {
        Integer l = ((z) this.f13435a).l(522);
        if (l == null) {
            return null;
        }
        return new DecimalFormat("0.#").format(v(l.intValue()));
    ...
    public String w() {
        Integer l = ((z) this.f13435a).l(260);
        if (l == null) {
            return null;
        }
        String format = String.format("%04X", l);
    ...
    public String z() {
        ...
        try {
            return c.get(String.format("%X %02X", Integer.valueOf(Integer.parseInt(split[0])), Integer.valueOf(Integer.parseInt(split[2]))));
        } catch (NumberFormatException unused) {
            return null;
        }
    }
