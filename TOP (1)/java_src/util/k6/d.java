...
public class d extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(49421, ExifInterface.TAG_CONTRAST);
        ...
        hashMap.put(49422, ExifInterface.TAG_SATURATION);
        hashMap.put(49410, "Self Timer Delay");
        hashMap.put(49423, ExifInterface.TAG_SHARPNESS);
        ...
        hashMap.put(Integer.valueOf((int) PrimitiveTags.INPUT_DATE), "Aspect Information Array");
        ...
        hashMap.put(Integer.valueOf((int) PrimitiveTags.FREE_TEXT), "Sensor Information Array");
        hashMap.put(16385, "Color Data Array 1");
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_STYLUS), "CRW Parameters");
        ...
        if (i == 1) {
            ...
            while (i4 < iArr5.length) {
                ...
                if (i6 == 53768 || i6 == 53769) {
                    ...
                    super.N(i6, Integer.valueOf(iArr5[i4]));
                }
                i5++;
                i4++;
            }
