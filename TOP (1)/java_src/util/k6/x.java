...
public class x extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_DPAD), "AE Lock");
        ...
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_GAMEPAD), "Flash Exposure Comp");
