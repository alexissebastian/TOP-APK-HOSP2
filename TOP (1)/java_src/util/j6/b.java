...
public abstract class b extends com.drew.metadata.b {
    ...
    public static void V(HashMap<Integer, String> hashMap) {
        ...
        hashMap.put(Integer.valueOf((int) Constants.LANDSCAPE_270), "Image Description");
        ...
        hashMap.put(Integer.valueOf((int) TypedValues.AttributesType.TYPE_EASING), "Predictor");
        hashMap.put(Integer.valueOf((int) TypedValues.AttributesType.TYPE_PATH_ROTATE), "Host Computer");
        hashMap.put(Integer.valueOf((int) TypedValues.AttributesType.TYPE_PIVOT_TARGET), "White Point");
        ...
        hashMap.put(Integer.valueOf((int) FragmentTransaction.TRANSIT_FRAGMENT_OPEN), "Related Image Width");
        hashMap.put(Integer.valueOf((int) InputDeviceCompat.SOURCE_TOUCHSCREEN), "Related Image Height");
        ...
        hashMap.put(33432, ExifInterface.TAG_COPYRIGHT);
        ...
        hashMap.put(37385, ExifInterface.TAG_FLASH);
        ...
        hashMap.put(41992, ExifInterface.TAG_CONTRAST);
        hashMap.put(41993, ExifInterface.TAG_SATURATION);
        hashMap.put(41994, ExifInterface.TAG_SHARPNESS);
        ...
        hashMap.put(42240, ExifInterface.TAG_GAMMA);
