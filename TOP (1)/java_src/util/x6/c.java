...
public class c {
    ...
    private static HashMap<Integer, HashMap<String, String>> f16004a = new HashMap<>();
    private static HashMap<String, String> b = new HashMap<>();
    private static HashMap<String, String> c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private static HashMap<String, String> f16005d = new HashMap<>();
    private static HashMap<String, String> e = new HashMap<>();

    static {
        f16004a.put(1, b);
        f16004a.put(110, c);
        f16004a.put(101, f16005d);
        f16004a.put(101, e);
        ...
        f16005d.put("NONE", "");
        f16005d.put("raw ", "Uncompressed in offset-binary format");
        f16005d.put("twos", "Uncompressed in two's-complement format");
        f16005d.put("sowt", "16-bit little-endian, twos-complement");
        f16005d.put("MAC3", "MACE 3:1");
        f16005d.put("MAC6", "MACE 6:1");
        f16005d.put("ima4", "IMA 4:1");
        f16005d.put("fl32", "32-bit floating point");
        f16005d.put("fl64", "64-bit floating point");
        f16005d.put("in24", "24-bit integer");
        f16005d.put("in32", "32-bit integer");
        f16005d.put("ulaw", "uLaw 2:1");
        f16005d.put("alaw", "uLaw 2:1");
        f16005d.put("ms\u0000\u0002", "Microsoft ADPCM-ACM code 2");
        f16005d.put("ms\u0000\u0011", "DVI/Intel IMAADPCM-ACM code 17");
        f16005d.put("dvca", "DV Audio");
        f16005d.put("QDMC", "QDesign music");
        f16005d.put("QDM2", "QDesign music version 2");
        f16005d.put("Qclp", "QUALCOMM PureVoice");
        f16005d.put("ms\u0000U", "MPEG-1 layer 3, CBR only (pre-QT4.1)");
        f16005d.put(".mp3", "MPEG-1 layer 3, CBR & VBR (QT4.1 and later)");
        f16005d.put("mp4a", "MPEG-4, Advanced Audio Coding (AAC)");
        f16005d.put("ac-3", "Digital Audio Compression Standard (AC-3, Enhanced AC-3)");
        f16005d.put("aac ", "ISO/IEC 144963-3 AAC");
        f16005d.put("agsm", "Apple GSM 10:1");
        f16005d.put("alac", "Apple Lossless Audio Codec");
        f16005d.put("conv", "Sample Format");
        f16005d.put("dvi ", "DV 4:1");
        f16005d.put("eqal", "Frequency Equalizer");
        f16005d.put("lpc ", "LPC 23:1");
        f16005d.put("mixb", "8-bit Mixer");
        f16005d.put("mixw", "16-bit Mixer");
        f16005d.put("MS\u0000\u0002", "Microsoft ADPCM");
        f16005d.put("MS\u0000\u0011", "DV IMA");
        f16005d.put("MS\u0000U", "MPEG3");
        f16005d.put("ratb", "8-bit Rate");
        f16005d.put("ratw", "16-bit Rate");
        f16005d.put("sour", "Sound Source");
        f16005d.put("str1", "Iomega MPEG layer II");
        f16005d.put("str2", "Iomega MPEG *layer II");
        f16005d.put("str3", "Iomega MPEG **layer II");
        f16005d.put("str4", "Iomega MPEG ***layer II");
        f16005d.put("lpcm", "Linear Pulse Code Modulation");
    ...
    public static String a(int i, String str) {
        return (f16004a.containsKey(Integer.valueOf(i)) && f16004a.get(Integer.valueOf(i)).containsKey(str)) ? f16004a.get(Integer.valueOf(i)).get(str) : "Unknown";
    }
}
