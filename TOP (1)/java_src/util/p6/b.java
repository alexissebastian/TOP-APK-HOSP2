...
public class b extends com.drew.metadata.b {
    ...
    static {
        ...
        hashMap.put(Integer.valueOf((int) TypedValues.AttributesType.TYPE_PATH_ROTATE), "Envelope Priority");
        ...
        hashMap.put(Integer.valueOf((int) TypedValues.MotionType.TYPE_QUANTIZE_MOTION_PHASE), "City");
        hashMap.put(Integer.valueOf((int) TypedValues.MotionType.TYPE_QUANTIZE_INTERPOLATOR), "Sub-location");
        hashMap.put(Integer.valueOf((int) TypedValues.MotionType.TYPE_PATHMOTION_ARC), "Province/State");
        hashMap.put(Integer.valueOf((int) TypedValues.MotionType.TYPE_QUANTIZE_INTERPOLATOR_ID), "Country/Primary Location Code");
