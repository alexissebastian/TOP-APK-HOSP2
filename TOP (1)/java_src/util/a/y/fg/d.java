...
public abstract class d {
    ...
    public static boolean m7946(int[] iArr) {
        if (iArr[0] != 1) {
            return false;
        }
        for (int i = 1; i < 5; i++) {
    ...
    /* renamed from: ˊ  reason: contains not printable characters */
    public static int[] m7947() {
        return new int[5];
    }

    /* renamed from: ˋ  reason: contains not printable characters */
    public static int m7948(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    public static void m7953(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* renamed from: ˎ  reason: contains not printable characters */
    public static int[] m7954() {
        return new int[10];
    }

    /* renamed from: ˏ  reason: contains not printable characters */
    public static boolean m7958(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
            if (iArr[i] != iArr2[i]) {
                return false;
            }
    ...
    public static int m7960(int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    /* renamed from: ˏ  reason: contains not printable characters */
    public static int m7956(int[] iArr, int[] iArr2, int[] iArr3) {
        int i;
        int i2;
        int i3;
        int i4;
    ...
    /* renamed from: ˊ  reason: contains not printable characters */
    public static int m7943(int i, long j, int[] iArr, int i2) {
        ...
        return c.m7917(5, iArr, i2, 4);
    }

    /* renamed from: ˋ  reason: contains not printable characters */
    public static boolean m7951(int[] iArr, int[] iArr2) {
        for (int i = 4; i >= 0; i--) {
    ...
    /* renamed from: ॱ  reason: contains not printable characters */
    public static int[] m7963(BigInteger bigInteger) {
        if (bigInteger.signum() >= 0 && bigInteger.bitLength() <= 160) {
            int[] m7947 = m7947();
            int i = 0;
            while (bigInteger.signum() != 0) {
                m7947[i] = bigInteger.intValue();
    ...
    /* renamed from: ˊ  reason: contains not printable characters */
    public static int m7945(int[] iArr, int[] iArr2, int[] iArr3) {
        long j = ((iArr[0] & 4294967295L) - (iArr2[0] & 4294967295L)) + 0;
        iArr3[0] = (int) j;
        long j2 = (j >> 32) + ((iArr[1] & 4294967295L) - (iArr2[1] & 4294967295L));
        iArr3[1] = (int) j2;
    ...
    /* renamed from: ˋ  reason: contains not printable characters */
    public static boolean m7950(int[] iArr) {
        for (int i = 0; i < 5; i++) {
            if (iArr[i] != 0) {
                return false;
            }
    ...
    /* renamed from: ˋ  reason: contains not printable characters */
    public static long m7949(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
    ...
    /* renamed from: ॱ  reason: contains not printable characters */
    public static int m7959(int[] iArr, int i) {
        int i2;
        if (i == 0) {
            i2 = iArr[0];
        } else {
    ...
    /* renamed from: ॱ  reason: contains not printable characters */
    public static void m7962(int[] iArr, int[] iArr2) {
    ...
    /* renamed from: ˏ  reason: contains not printable characters */
    public static int m7955(int i, int i2, int[] iArr, int i3) {
        ...
        return c.m7917(5, iArr, i3, 3);
    }

    /* renamed from: ˊ  reason: contains not printable characters */
    public static int m7944(int[] iArr, int[] iArr2) {
    ...
    /* renamed from: ˎ  reason: contains not printable characters */
    public static int m7952(int i, int i2, int[] iArr, int i3) {
        int i4 = i3 + 0;
        ...
        return c.m7917(5, iArr, i3, 2);
    }

    /* renamed from: ˏ  reason: contains not printable characters */
    public static BigInteger m7957(int[] iArr) {
        byte[] bArr = new byte[20];
        for (int i = 0; i < 5; i++) {
            int i2 = iArr[i];
            if (i2 != 0) {
                util.a.y.fj.g.m8698(i2, bArr, (4 - i) << 2);
            }
        }
    ...
    /* renamed from: ॱ  reason: contains not printable characters */
    public static void m7961(int[] iArr) {
        iArr[0] = 0;
        iArr[1] = 0;
        iArr[2] = 0;
        iArr[3] = 0;
