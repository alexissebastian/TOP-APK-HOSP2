...
public final class a {
    ...
    public static final Matrix f14482a = new Matrix();
    ...
    private static String a(@NonNull Resources resources, @NonNull View view) {
        ...
        if (!view.getMatrix().equals(f14482a)) {
            sb.append(", ");
            sb.append("matrix=");
    ...
    @NonNull
    private static String c(@NonNull View view) {
    ...
    public static int d(@NonNull String str, @NonNull String str2) {
        ...
        while (str2.length() > 0) {
            ...
            String.format(Locale.US, "%02d: %s", Integer.valueOf(i), str2.substring(0, min));
    ...
    @NonNull
    private static String e(@Nullable Resources resources, @NonNull View view) {
        if (resources == null) {
            return "";
        }
        try {
