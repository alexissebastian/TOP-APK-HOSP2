...
public final class ThreadPoolDispatcher extends ExecutorCoroutineDispatcherBase {
    ...
    public ThreadPoolDispatcher(int i, @NotNull String str) {
        this.nThreads = i;
        this.name = str;
        this.executor = Executors.newScheduledThreadPool(i, new ThreadFactory() { // from class: kotlinx.coroutines.d
            @Override // java.util.concurrent.ThreadFactory
            public final Thread newThread(Runnable runnable) {
                Thread m1814executor$lambda0;
                m1814executor$lambda0 = ThreadPoolDispatcher.m1814executor$lambda0(ThreadPoolDispatcher.this, runnable);
                return m1814executor$lambda0;
            }
        });
    ...
    public static final Thread m1814executor$lambda0(ThreadPoolDispatcher threadPoolDispatcher, Runnable runnable) {
        String str;
