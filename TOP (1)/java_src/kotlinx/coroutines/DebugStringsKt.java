...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(@NotNull Continuation<?> continuation) {
        ...
        try {
            ...
            m319constructorimpl = Result.m319constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
        ...
        if (Result.m322exceptionOrNullimpl(m319constructorimpl) != null) {
            m319constructorimpl = ((Object) continuation.getClass().getName()) + '@' + getHexAddress(continuation);
        }
