...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1852catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m1844catch(sharedFlow, function3);
    }
