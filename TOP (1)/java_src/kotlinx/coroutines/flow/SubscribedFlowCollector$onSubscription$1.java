...
@DebugMetadata(c = "kotlinx.coroutines.flow.SubscribedFlowCollector", f = "Share.kt", i = {0}, l = {WalletConstants.ERROR_CODE_INVALID_TRANSACTION, 414}, m = "onSubscription", n = {"safeCollector"}, s = {"L$1"})
