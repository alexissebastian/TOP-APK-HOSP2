            ...
            if (i == 0) {
                ...
                Object obj3 = new FlowCollector<T1>() { // from class: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2$invokeSuspend$$inlined$collect$1
                    ...
                    public Object emit(T1 t1, @NotNull Continuation<? super Unit> continuation) {
                        ...
                        Object withContextUndispatched = ChannelFlowKt.withContextUndispatched(coroutineContext2, unit, obj2, new CombineKt$zipImpl$1$1$2$1$1(receiveChannel, flowCollector, function3, t1, null), continuation);
                        coroutine_suspended2 = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
                        return withContextUndispatched == coroutine_suspended2 ? withContextUndispatched : unit;
                    }
                };
                this.label = 1;
