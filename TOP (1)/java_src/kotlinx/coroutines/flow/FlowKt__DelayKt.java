...
public final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1847debounceHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m1807toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m1848sampleHG0u8IE(@NotNull Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m1807toDelayMillisLRDsOJo(j));
    }
