...
public final class AgentPremain {
    ...
    static {
        ...
        Boolean bool = Result.m325isFailureimpl(m319constructorimpl) ? null : m319constructorimpl;
    ...
    private final void installSignalHandler() {
        try {
            Signal.handle(new Signal("TRAP"), a.f14633a);
        } catch (Throwable unused) {
        }
    }

    /* renamed from: installSignalHandler$lambda-1  reason: not valid java name */
    private static final void m1843installSignalHandler$lambda1(Signal signal) {
