    ...
    public static final <T> void resumeCancellableWith(@NotNull Continuation<? super T> continuation, @NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        if (continuation instanceof DispatchedContinuation) {
            ...
            if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.getContext())) {
                ...
                dispatchedContinuation.dispatcher.mo1865dispatch(dispatchedContinuation.getContext(), dispatchedContinuation);
                return;
            }
            ...
            try {
                ...
                if (job == null || job.isActive()) {
                    ...
                    dispatchedContinuation.resumeWith(Result.m319constructorimpl(ResultKt.createFailure(cancellationException)));
                    z = true;
                }
                if (!z) {
