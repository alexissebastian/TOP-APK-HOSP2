...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m319constructorimpl = Result.m319constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m319constructorimpl = Result.m319constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m325isFailureimpl(m319constructorimpl) ? null : m319constructorimpl;
    }
    ...
    public static final Object awaitFrame(@NotNull Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1865dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.a
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1817postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m1817postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
        Dispatchers dispatchers = Dispatchers.INSTANCE;
