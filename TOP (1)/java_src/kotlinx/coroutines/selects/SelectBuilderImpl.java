...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(@NotNull Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m319constructorimpl(ResultKt.createFailure(th)));
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (atomicReferenceFieldUpdater.compareAndSet(this, coroutine_suspended2, SelectKt.access$getRESUMED$p())) {
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m319constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        }
            ...
            if (obj2 == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (atomicReferenceFieldUpdater.compareAndSet(this, coroutine_suspended2, SelectKt.access$getRESUMED$p())) {
                    if (Result.m325isFailureimpl(obj)) {
                        ...
                        Intrinsics.checkNotNull(m322exceptionOrNullimpl);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m322exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m322exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m319constructorimpl(ResultKt.createFailure(m322exceptionOrNullimpl)));
                        return;
                    }
