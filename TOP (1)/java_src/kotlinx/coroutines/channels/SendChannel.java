...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(@NotNull SendChannel<? super E> sendChannel, E e) {
            ...
            if (ChannelResult.m1836isSuccessimpl(mo1821trySendJP2dKIU)) {
                return true;
            }
            Throwable m1830exceptionOrNullimpl = ChannelResult.m1830exceptionOrNullimpl(mo1821trySendJP2dKIU);
    ...
    Object mo1821trySendJP2dKIU(E e);
}
