...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public static final class Itr<E> implements ChannelIterator<E> {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        orCreateCancellableContinuation.resumeWith(Result.m319constructorimpl(boxBoolean));
                    } else {
                        Throwable receiveException = closed.getReceiveException();
                        Result.Companion companion2 = Result.Companion;
                        orCreateCancellableContinuation.resumeWith(Result.m319constructorimpl(ResultKt.createFailure(receiveException)));
                    }
                } else if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                    Boolean boxBoolean2 = Boxing.boxBoolean(true);
                    Function1<E, Unit> function1 = this.channel.onUndeliveredElement;
                    orCreateCancellableContinuation.resume(boxBoolean2, function1 == null ? null : OnUndeliveredElementKt.bindCancellationFun(function1, pollInternal, orCreateCancellableContinuation.getContext()));
                }
            }
        ...
        public Object hasNext(@NotNull Continuation<? super Boolean> continuation) {
            ...
            return getResult() != symbol ? Boxing.boxBoolean(hasNextResult(getResult())) : hasNextSuspend(continuation);
        }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.receiveMode == 1) {
                ...
                ChannelResult m1826boximpl = ChannelResult.m1826boximpl(ChannelResult.Companion.m1839closedJP2dKIU(closed.closeCause));
                Result.Companion companion = Result.Companion;
                cancellableContinuation.resumeWith(Result.m319constructorimpl(m1826boximpl));
                return;
            }
            CancellableContinuation<Object> cancellableContinuation2 = this.cont;
            Throwable receiveException = closed.getReceiveException();
            Result.Companion companion2 = Result.Companion;
            cancellableContinuation2.resumeWith(Result.m319constructorimpl(ResultKt.createFailure(receiveException)));
        }

        @Nullable
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1826boximpl(ChannelResult.Companion.m1841successJP2dKIU(e)) : e;
        }
    ...
    public static class ReceiveHasNext<E> extends Receive<E> {
        ...
        @Nullable
        public Symbol tryResumeReceive(E e, @Nullable LockFreeLinkedListNode.PrepareOp prepareOp) {
            Object tryResume = this.cont.tryResume(Boolean.TRUE, prepareOp == null ? null : prepareOp.desc, resumeOnCancellationFun(e));
            if (tryResume == null) {
                return null;
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1826boximpl(ChannelResult.Companion.m1841successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(@NotNull Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1826boximpl(ChannelResult.Companion.m1839closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i == 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1826boximpl(z ? companion.m1839closedJP2dKIU(((Closed) obj).closeCause) : companion.m1841successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, obj, selectInstance.getCompletion());
        } else if (i != 0) {
            if (i == 1 && selectInstance.trySelect()) {
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1826boximpl(ChannelResult.Companion.m1839closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else {
        ...
        if (closedForSend != null) {
            ...
            while (true) {
                ...
                if (prevNode instanceof LockFreeLinkedListHead) {
                    mo1818onCancelIdempotentListww6eGU(m1857constructorimpl$default, closedForSend);
                    return;
                    ...
                    if (!prevNode.remove()) {
                        ...
                        m1857constructorimpl$default = InlineList.m1862plusFjFbRPM(m1857constructorimpl$default, (Send) prevNode);
                    }
                }
            }
        } else {
    ...
    */
    public final java.lang.Object mo1819receiveCatchingJP2dKIU(@org.jetbrains.annotations.NotNull kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L31:
            ...
            java.lang.Object r5 = r0.m1839closedJP2dKIU(r5)
            goto L51
        L4b:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1841successJP2dKIU(r5)
        L51:
            return r5
        L52:
            r0.label = r3
        ...
        L5b:
            ...
            java.lang.Object r5 = r5.m1838unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1819receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public final Object mo1820tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1840failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1839closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1841successJP2dKIU(pollInternal);
    }
