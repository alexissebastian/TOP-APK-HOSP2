...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> void sendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1836isSuccessimpl(sendChannel.mo1821trySendJP2dKIU(e))) {
            return;
        }
    ...
    public static final <E> Object trySendBlocking(@NotNull SendChannel<? super E> sendChannel, E e) throws InterruptedException {
        Object mo1821trySendJP2dKIU = sendChannel.mo1821trySendJP2dKIU(e);
        if (!(mo1821trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1821trySendJP2dKIU;
            return ChannelResult.Companion.m1841successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m1838unboximpl();
    }
}
