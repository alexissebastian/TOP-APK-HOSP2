...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final boolean isActive(@NotNull CoroutineContext coroutineContext) {
        Job job = (Job) coroutineContext.get(Job.Key);
        return Intrinsics.areEqual(job == null ? null : Boolean.valueOf(job.isActive()), Boolean.TRUE);
    }
    ...
    @JvmName(name = "Job")
    /* renamed from: Job */
    public static final /* synthetic */ Job m1810Job(Job job) {
        return JobKt.Job(job);
    }

    /* renamed from: Job$default */
    public static /* synthetic */ Job m1811Job$default(Job job, int i, Object obj) {
        Job m1810Job;
        if ((i & 1) != 0) {
            job = null;
        }
        m1810Job = m1810Job(job);
        return m1810Job;
    }
