...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(@NotNull Object obj, @Nullable Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m322exceptionOrNullimpl, false, 2, null);
    }
    ...
    public static final <T> Object toState(@NotNull Object obj, @NotNull CancellableContinuation<?> cancellableContinuation) {
        ...
        if (m322exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (cancellableContinuation instanceof CoroutineStackFrame)) {
                m322exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m322exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation);
            }
            obj = new CompletedExceptionally(m322exceptionOrNullimpl, false, 2, null);
        }
        return obj;
    }
}
