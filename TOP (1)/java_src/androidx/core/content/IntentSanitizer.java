...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        private boolean mAllowSourceBounds;
        private int mAllowedFlags;
        private Predicate<String> mAllowedActions = e.f12021a;
        private Predicate<Uri> mAllowedData = i.f12025a;
        private Predicate<String> mAllowedTypes = a.f12017a;
        private Predicate<String> mAllowedCategories = j.f12026a;
        private Predicate<String> mAllowedPackages = h.f12024a;
        private Predicate<ComponentName> mAllowedComponents = o.f12031a;
        private Map<String, Predicate<Object>> mAllowedExtras = new HashMap();
        private boolean mAllowClipDataText = false;
        private Predicate<Uri> mAllowedClipDataUri = b.f12018a;
        private Predicate<ClipData> mAllowedClipData = q.f12033a;
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = d.f12020a;
            return this;
        }
        ...
        public Builder allowCategory(@NonNull String str) {
            Preconditions.checkNotNull(str);
            Objects.requireNonNull(str);
            return allowCategory(new w(str));
        }
        ...
        public Builder allowClipDataUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.g
        ...
        public Builder allowComponent(@NonNull final ComponentName componentName) {
            ...
            return allowComponent(new Predicate() { // from class: androidx.core.content.v
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return Objects.requireNonNull(predicate);
                }
        ...
        public Builder allowExtra(@NonNull String str, @NonNull Class<?> cls) {
            return allowExtra(str, cls, l.f12028a);
        }
        ...
        public Builder allowExtraStreamUriWithAuthority(@NonNull final String str) {
            Preconditions.checkNotNull(str);
            allowExtra("android.intent.extra.STREAM", Uri.class, new Predicate() { // from class: androidx.core.content.n
                @Override // androidx.core.util.Predicate
                public /* synthetic */ Predicate and(Predicate predicate) {
                    return Objects.requireNonNull(predicate);
                }
        ...
        public <T> Builder allowExtra(@NonNull String str, @NonNull final Class<T> cls, @NonNull final Predicate<T> predicate) {
            ...
            Preconditions.checkNotNull(predicate);
            return allowExtra(str, new Predicate() { // from class: androidx.core.content.p
                @Override // androidx.core.util.Predicate
    ...
    public Intent sanitizeByFiltering(@NonNull Intent intent) {
        return sanitize(intent, s.k0);
    }

    @NonNull
    public Intent sanitizeByThrowing(@NonNull Intent intent) {
        return sanitize(intent, r.k0);
    }
