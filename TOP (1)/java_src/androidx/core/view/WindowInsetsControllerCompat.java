...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        private void showForType(int i) {
            if (i == 1) {
                ...
                view.post(new Runnable() { // from class: androidx.core.view.g
    ...
    public static class Impl30 extends Impl {
        ...
        void addOnControllableInsetsChangedListener(@NonNull final OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener onControllableInsetsChangedListener2 = new WindowInsetsController.OnControllableInsetsChangedListener() { // from class: androidx.core.view.h
                @Override // android.view.WindowInsetsController.OnControllableInsetsChangedListener
                public final void onControllableInsetsChanged(WindowInsetsController windowInsetsController, int i) {
                    WindowInsetsControllerCompat.Impl30.this.b(onControllableInsetsChangedListener, windowInsetsController, i);
                }
            };
