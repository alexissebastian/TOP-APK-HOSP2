    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (i3 >= 23) {
            if (action.getIcon() == null && (i2 = action.icon) != 0) {
                return new Action(i2, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
            }
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
        }
        return new Action(action.icon, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, i5, z3, isContextual, isAuthenticationRequired);
    }
