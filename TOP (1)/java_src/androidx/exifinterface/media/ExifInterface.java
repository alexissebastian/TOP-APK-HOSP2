...
public class ExifInterface {
    ...
    /* JADX WARN: Removed duplicated region for block: B:61:0x016b A[LOOP:0: B:10:0x0032->B:61:0x016b, LOOP_END] */
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(substring) || "-".equals(substring)) && OobNotificationProfile.SEPERATOR.equals(str3.substring(3, 4)) && parseInt <= 14) {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:58:0x01a5 A[Catch: all -> 0x01e7, Exception -> 0x01ea, TryCatch #4 {Exception -> 0x01ea, all -> 0x01e7, blocks: (B:7:0x0047, B:9:0x0050, B:63:0x01c7, B:10:0x0069, B:12:0x0071, B:14:0x007d, B:16:0x0085, B:18:0x0089, B:22:0x009c, B:24:0x00a7, B:25:0x00ac, B:27:0x00b9, B:28:0x00be, B:29:0x00c2, B:30:0x00ce, B:32:0x00d6, B:34:0x00de, B:36:0x00e6, B:38:0x00ea, B:40:0x00f5, B:42:0x0100, B:44:0x0108, B:56:0x0153, B:58:0x01a5, B:62:0x01c1, B:59:0x01b1, B:61:0x01b9, B:45:0x0117, B:46:0x011e, B:47:0x011f, B:49:0x0127, B:51:0x012d, B:52:0x0146, B:53:0x014d, B:66:0x01df, B:67:0x01e6), top: B:82:0x0047 }] */
    /* JADX WARN: Removed duplicated region for block: B:59:0x01b1 A[Catch: all -> 0x01e7, Exception -> 0x01ea, TryCatch #4 {Exception -> 0x01ea, all -> 0x01e7, blocks: (B:7:0x0047, B:9:0x0050, B:63:0x01c7, B:10:0x0069, B:12:0x0071, B:14:0x007d, B:16:0x0085, B:18:0x0089, B:22:0x009c, B:24:0x00a7, B:25:0x00ac, B:27:0x00b9, B:28:0x00be, B:29:0x00c2, B:30:0x00ce, B:32:0x00d6, B:34:0x00de, B:36:0x00e6, B:38:0x00ea, B:40:0x00f5, B:42:0x0100, B:44:0x0108, B:56:0x0153, B:58:0x01a5, B:62:0x01c1, B:59:0x01b1, B:61:0x01b9, B:45:0x0117, B:46:0x011e, B:47:0x011f, B:49:0x0127, B:51:0x012d, B:52:0x0146, B:53:0x014d, B:66:0x01df, B:67:0x01e6), top: B:82:0x0047 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (DEBUG) {
            for (int i6 = 0; i6 < EXIF_TAGS.length; i6++) {
                String.format("index: %d, offsets: %d, tag count: %d, data sizes: %d, total size: %d", Integer.valueOf(i6), Integer.valueOf(iArr[i6]), Integer.valueOf(this.mAttributes[i6].size()), Integer.valueOf(iArr2[i6]), Integer.valueOf(i4));
            }
        }
        if (!this.mAttributes[1].isEmpty()) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x005b A[Catch: all -> 0x0094, Exception -> 0x00ad, TRY_ENTER, TRY_LEAVE, TryCatch #7 {Exception -> 0x00ad, all -> 0x0094, blocks: (B:33:0x005b, B:36:0x0071, B:38:0x007d, B:43:0x0088, B:44:0x008d, B:45:0x008e, B:46:0x0093, B:50:0x0099, B:51:0x009e), top: B:66:0x0059 }] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x0099 A[Catch: all -> 0x0094, Exception -> 0x00ad, TryCatch #7 {Exception -> 0x00ad, all -> 0x0094, blocks: (B:33:0x005b, B:36:0x0071, B:38:0x007d, B:43:0x0088, B:44:0x008d, B:45:0x008e, B:46:0x0093, B:50:0x0099, B:51:0x009e), top: B:66:0x0059 }] */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:78:0x0114 A[Catch: all -> 0x012d, Exception -> 0x0130, TryCatch #21 {Exception -> 0x0130, all -> 0x012d, blocks: (B:74:0x00ff, B:77:0x0105, B:80:0x011c, B:78:0x0114), top: B:136:0x00ff }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    ...
    public void setAltitude(double d2) {
        String str = d2 >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? "0" : "1";
    ...
    public void setAttribute(@NonNull String str, @Nullable String str2) {
        ...
        if ((TAG_DATETIME.equals(str3) || TAG_DATETIME_ORIGINAL.equals(str3) || TAG_DATETIME_DIGITIZED.equals(str3)) && str4 != null) {
            ...
            if (str2.length() != 19 || (!find && !find2)) {
                ...
                str4 = str4.replaceAll("-", OobNotificationProfile.SEPERATOR);
            }
        }
                    ...
                    switch (i) {
                        ...
                        case 5:
                            ...
                            while (i9 < split3.length) {
                                ...
                                rationalArr[i9] = new Rational((long) Double.parseDouble(split4[c]), (long) Double.parseDouble(split4[1]));
                                i9++;
                                c = 0;
                            }
    ...
    public void setLatLong(double d2, double d3) {
        if (d2 >= -90.0d && d2 <= 90.0d && !Double.isNaN(d2)) {
            if (d3 >= -180.0d && d3 <= 180.0d && !Double.isNaN(d3)) {
                setAttribute(TAG_GPS_LATITUDE_REF, d2 >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? "N" : LATITUDE_SOUTH);
                setAttribute(TAG_GPS_LATITUDE, convertDecimalDegree(Math.abs(d2)));
                setAttribute(TAG_GPS_LONGITUDE_REF, d3 >= FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE ? LONGITUDE_EAST : LONGITUDE_WEST);
