        ...
        final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            ...
            if (i == 1) {
                ...
                if (i == 3 && this.mFinalState != State.REMOVED) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        String str2 = "SpecialEffectsController: For fragment " + this.mFragment + " mFinalState = " + this.mFinalState + " -> " + state + ". ";
                    }
                    this.mFinalState = state;
                }
            } else {
                if (FragmentManager.isLoggingEnabled(2)) {
                    String str3 = "SpecialEffectsController: For fragment " + this.mFragment + " mFinalState = " + this.mFinalState + " -> REMOVED. mLifecycleImpact  = " + this.mLifecycleImpact + " to REMOVING.";
                }
