        ...
        if ("fragment".equals(str)) {
            ...
            if (findFragmentById == null) {
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    String str2 = "Fragment " + findFragmentById + " has been inflated via the <fragment> tag: id=0x" + Integer.toHexString(resourceId);
                }
                ...
                if (FragmentManager.isLoggingEnabled(2)) {
                    String str3 = "Retained Fragment " + findFragmentById + " has been re-attached via the <fragment> tag: id=0x" + Integer.toHexString(resourceId);
                }
            } else {
