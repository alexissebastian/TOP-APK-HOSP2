...
public class FragmentStateManager {
    ...
    public void destroy() {
        ...
        String str3 = this.mFragment.mTargetWho;
        if (str3 != null && (findActiveFragment = this.mFragmentStore.findActiveFragment(str3)) != null && findActiveFragment.mRetainInstance) {
