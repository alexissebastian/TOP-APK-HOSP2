...
public final class Exif {
    ...
    public Location getLocation() {
        ...
        double altitude = this.mExifInterface.getAltitude(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        double attributeDouble = this.mExifInterface.getAttributeDouble(ExifInterface.TAG_GPS_SPEED, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
