...
public final class ImageUtil {
    ...
    private static byte[] nv21ToJpeg(@NonNull byte[] bArr, int i, int i2, @Nullable Rect rect, @IntRange(from = 1, to = 100) int i3) throws CodecFailedException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
    ...
    @NonNull
    public static byte[] yuvImageToJpegByteArray(@NonNull ImageProxy imageProxy, @Nullable Rect rect, @IntRange(from = 1, to = 100) int i) throws CodecFailedException {
    ...
    public static final class CodecFailedException extends Exception {
        ...
        CodecFailedException(@NonNull String str) {
            super(str);
