...
public final class ImageAnalysis extends UseCase {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: d */
    public /* synthetic */ void e(Analyzer analyzer, ImageProxy imageProxy) {
    ...
    SessionConfig.Builder createPipeline(@NonNull final String str, @NonNull final ImageAnalysisConfig imageAnalysisConfig, @NonNull final Size size) {
        ...
        createFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.s
    ...
    public UseCaseConfig<?> onMergeConfig(@NonNull CameraInfoInternal cameraInfoInternal, @NonNull UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        return super.onMergeConfig(cameraInfoInternal, builder);
    }
        ...
        synchronized (this.mAnalysisLock) {
            this.mImageAnalysisAbstractAnalyzer.setAnalyzer(executor, new Analyzer() { // from class: androidx.camera.core.q
                ...
                public final void analyze(ImageProxy imageProxy) {
                    ImageAnalysis.this.e(analyzer, imageProxy);
                }
            });
            if (this.mSubscribedAnalyzer == null) {
                notifyActive();
