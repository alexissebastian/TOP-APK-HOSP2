...
public class CameraNoResponseWhenEnablingFlashQuirk implements UseTorchAsFlashQuirk {
    ...
    public static boolean load(@NonNull CameraCharacteristicsCompat cameraCharacteristicsCompat) {
        return "SAMSUNG".equals(Build.BRAND.toUpperCase(Locale.US)) && AFFECTED_MODELS.contains(Build.MODEL.toUpperCase()) && ((Integer) cameraCharacteristicsCompat.get(CameraCharacteristics.LENS_FACING)).intValue() == 1;
    }
}
