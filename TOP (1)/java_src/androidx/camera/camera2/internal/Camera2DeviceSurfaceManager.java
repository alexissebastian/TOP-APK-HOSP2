...
public final class Camera2DeviceSurfaceManager implements CameraDeviceSurfaceManager {
    ...
    Camera2DeviceSurfaceManager(@NonNull Context context, @NonNull CamcorderProfileHelper camcorderProfileHelper, @Nullable Object obj, @NonNull Set<String> set) throws CameraUnavailableException {
