...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    private class DevModeDraw {
        ...
        public void draw(Canvas canvas, HashMap<View, MotionController> hashMap, int i, int i2) {
            ...
            if (!MotionLayout.this.isInEditMode() && (i2 & 1) == 2) {
                String str = MotionLayout.this.getContext().getResources().getResourceName(MotionLayout.this.mEndState) + OobNotificationProfile.SEPERATOR + MotionLayout.this.getProgress();
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str5 = str4 + "  " + name + " " + constraintWidget + " " + sb8;
            }
    ...
    */
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f12015me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f12015me.tracker = VelocityTracker.obtain();
            return f12015me;
        }
