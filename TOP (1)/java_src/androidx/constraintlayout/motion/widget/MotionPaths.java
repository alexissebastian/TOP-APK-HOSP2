...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    public void getCenter(double d2, int[] iArr, double[] dArr, float[] fArr, int i) {
        ...
        if (motionController != null) {
            ...
            double d4 = f;
            double d5 = f2;
            f = (float) ((d3 + (Math.sin(d5) * d4)) - (f3 / 2.0f));
            f2 = (float) ((f7 - (d4 * Math.cos(d5))) - (f4 / 2.0f));
        }
    ...
    public void getRect(int[] iArr, double[] dArr, float[] fArr, int i) {
        ...
        if (motionController != null) {
            ...
            double d2 = f;
            double d3 = f2;
            f2 = (float) ((this.mRelativeToController.getCenterY() - (d2 * Math.cos(d3))) - (f4 / 2.0f));
            f = (float) ((centerX + (Math.sin(d3) * d2)) - (f3 / 2.0f));
        }
        float f6 = f3 + f;
        float f7 = f4 + f2;
    ...
    public void setView(float f, View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3, boolean z) {
        ...
        int i8 = i6 - i4;
        int i9 = i7 - i5;
        if (((i8 == view.getMeasuredWidth() && i9 == view.getMeasuredHeight()) ? true : true) || z) {
    ...
    public void getCenter(double d2, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        ...
        if (motionController != null) {
            ...
            double d5 = f6;
            double d6 = f8;
            float sin = (float) (f17 + (Math.sin(d4) * d5) + (Math.cos(d4) * d6));
            f14 = (float) ((f18 - (d5 * Math.cos(d4))) + (Math.sin(d4) * d6));
            f13 = sin;
            f2 = (float) ((f15 + (Math.sin(d4) * d3)) - (f4 / 2.0f));
            f3 = (float) ((f16 - (d3 * Math.cos(d4))) - (f5 / 2.0f));
            f12 = 2.0f;
        } else {
            f = f4;
        }
