...
public class Debug {
    public static void dumpLayoutParams(ViewGroup viewGroup, String str) {
        ...
        String str2 = ".(" + stackTraceElement.getFileName() + OobNotificationProfile.SEPERATOR + stackTraceElement.getLineNumber() + ") " + str + "  ";
    ...
    public static void dumpPoc(Object obj) {
        Field[] fields;
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        String str = ".(" + stackTraceElement.getFileName() + OobNotificationProfile.SEPERATOR + stackTraceElement.getLineNumber() + ")";
    ...
    public static String getCallFrom(int i) {
        ...
        return ".(" + stackTraceElement.getFileName() + OobNotificationProfile.SEPERATOR + stackTraceElement.getLineNumber() + ")";
    }

    public static String getLoc() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + OobNotificationProfile.SEPERATOR + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName() + "()";
    }
    ...
    public static void logStack(String str, String str2, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            str3 = str3 + " ";
            String str4 = str2 + str3 + (".(" + stackTrace[i2].getFileName() + OobNotificationProfile.SEPERATOR + stackTrace[i2].getLineNumber() + ") " + stackTrace[i2].getMethodName()) + str3;
        }
    }
    ...
    public static void printStack(String str, int i) {
        ...
        for (int i2 = 1; i2 <= min; i2++) {
            ...
            printStream.println(str + str2 + (".(" + stackTrace[i2].getFileName() + OobNotificationProfile.SEPERATOR + stackTrace[i2].getLineNumber() + ") ") + str2);
        }
    }
