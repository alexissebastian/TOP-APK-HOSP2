...
public class MotionController {
    ...
    private float getPreCycleDistance() {
        ...
        while (i < 100) {
            ...
            if (i2 > 0) {
                c = 0;
                f = (float) (f9 + Math.hypot(d3 - fArr[1], d2 - fArr[0]));
            } else {
                c = 0;
                f = f9;
            }
    ...
    private void insertKey(MotionPaths motionPaths) {
        ...
        if (Collections.binarySearch(this.mMotionPaths, motionPaths) == 0) {
            r0 = " KeyPath position \"" + motionPaths.position + "\" outside of range";
        }
    ...
    void buildBounds(float[] fArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (easing != null) {
                ...
                d2 = (((float) easing.get((f3 - f5) / f)) * (f7 - f5)) + f5;
            }
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i2 < i) {
            ...
            if (easing != null) {
                ...
                d2 = (((float) easing.get((f7 - f9) / f)) * (f8 - f9)) + f9;
            } else {
                d2 = d5;
            }
            this.mSpline[0].getPos(d2, this.mInterpolateData);
