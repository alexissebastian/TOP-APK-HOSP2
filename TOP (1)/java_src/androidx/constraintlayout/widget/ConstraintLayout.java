        ...
        if (i23 != -1) {
            ...
            if (i9 != -1) {
                ...
                if (constraintWidget7 != null) {
                    ...
                    constraintWidget.immediateConnect(type, constraintWidget7, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i3);
                }
            } else if (i10 != -1 && (constraintWidget2 = sparseArray.get(i10)) != null) {
                constraintWidget.immediateConnect(ConstraintAnchor.Type.LEFT, constraintWidget2, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i3);
            }
            if (i4 != -1) {
            ...
            } else if (i2 != -1 && (constraintWidget3 = sparseArray.get(i2)) != null) {
            ...
            if (i28 != -1) {
                setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i28, ConstraintAnchor.Type.BASELINE);
            } else {
                int i29 = layoutParams.baselineToTop;
                if (i29 != -1) {
                    setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i29, ConstraintAnchor.Type.TOP);
                } else {
                    int i30 = layoutParams.baselineToBottom;
                    if (i30 != -1) {
                        setWidgetBaseline(constraintWidget, layoutParams, sparseArray, i30, ConstraintAnchor.Type.BOTTOM);
                    }
                }
            }
            if (f >= 0.0f) {
