...
public class ConstraintAttribute {
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            e2.getMessage();
            r0 = " Custom Attribute \"" + str2 + "\" not found on " + cls.getName();
            String str4 = cls.getName() + " must have a method " + str;
        } catch (InvocationTargetException e3) {
            String str5 = " Custom Attribute \"" + str2 + "\" not found on " + cls.getName();
            e3.printStackTrace();
        }
    }
