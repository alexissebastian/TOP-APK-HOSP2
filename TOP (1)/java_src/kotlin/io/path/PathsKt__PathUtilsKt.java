...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Void fileAttributeViewNotAvailable(@NotNull Path path, @NotNull Class<?> attributeViewClass) {
        ...
        throw new UnsupportedOperationException("The desired attribute view type " + attributeViewClass + " is not available for the file " + path + JwtParser.SEPARATOR_CHAR);
    }
    ...
    public static final String getExtension(@NotNull Path path) {
        ...
        substringAfterLast = StringsKt__StringsKt.substringAfterLast(fileName.toString(), (char) JwtParser.SEPARATOR_CHAR, "");
    ...
    public static final String getNameWithoutExtension(@NotNull Path path) {
        ...
        substringBeforeLast$default = StringsKt__StringsKt.substringBeforeLast$default(fileName.toString(), ".", (String) null, 2, (Object) null);
