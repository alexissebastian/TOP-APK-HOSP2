...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark mo1639plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1681plusLRDsOJo(this.offset, j), null);
        }
    }
    ...
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1747getZEROUwyO8pc(), null);
    }
