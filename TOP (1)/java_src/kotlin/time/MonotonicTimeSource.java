...
public final class MonotonicTimeSource implements TimeSource {
    ...
    public final long m1775adjustReading6QKq23U(long j, long j2) {
        return TimeSource.Monotonic.ValueTimeMark.m1784constructorimpl(LongSaturatedMathKt.m1773saturatingAddpTJri5U(j, j2));
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m1776elapsedFrom6eNON_k(long j) {
        return LongSaturatedMathKt.saturatingDiff(read(), j);
    }

    @Override // kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ TimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1783boximpl(m1777markNowz9LOYto());
    }

    /* renamed from: markNow-z9LOYto  reason: not valid java name */
    public long m1777markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1784constructorimpl(read());
    }
