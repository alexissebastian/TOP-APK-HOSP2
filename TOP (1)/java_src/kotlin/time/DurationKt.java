...
public final class DurationKt {
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m1645constructorimpl((j << 1) + i);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1645constructorimpl((j << 1) + 1);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1645constructorimpl(j << 1);
    }
    ...
    */
    ...
    private static final long m1770timeskIfJnKk(double d2, long j) {
        return Duration.m1682timesUwyO8pc(j, d2);
    }
    ...
    private static final long m1771timesmvk6XK0(int i, long j) {
        return Duration.m1683timesUwyO8pc(j, i);
    }
