...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1801toJavaDurationLRDsOJo(long j) {
        Duration ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1666getInWholeSecondsimpl(j), kotlin.time.Duration.m1668getNanosecondsComponentimpl(j));
