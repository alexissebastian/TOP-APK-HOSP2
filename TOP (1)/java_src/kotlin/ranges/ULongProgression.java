...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1569fromClosedRange7ftBX0g(long j, long j2, long j3) {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        if (j3 != Long.MIN_VALUE) {
            this.first = j;
            this.last = UProgressionUtilKt.m1545getProgressionLastElement7ftBX0g(j, j2, j3);
            this.step = j3;
            return;
        }
    ...
    public final long m1567getFirstsVKNKU() {
        return this.first;
    }

    /* renamed from: getLast-s-VKNKU  reason: not valid java name */
    public final long m1568getLastsVKNKU() {
        return this.last;
    }
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m491constructorimpl(j ^ ULong.m491constructorimpl(j >>> 32))) * 31) + ((int) ULong.m491constructorimpl(j2 ^ ULong.m491constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m536toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m536toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
