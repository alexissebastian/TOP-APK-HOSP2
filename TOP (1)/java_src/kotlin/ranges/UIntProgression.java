...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1562fromClosedRangeNkh28Cs(int i, int i2, int i3) {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        if (i3 != Integer.MIN_VALUE) {
            this.first = i;
            this.last = UProgressionUtilKt.m1546getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
            return;
        }
    ...
    public final int m1560getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m1561getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m458toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) UInt.m458toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
