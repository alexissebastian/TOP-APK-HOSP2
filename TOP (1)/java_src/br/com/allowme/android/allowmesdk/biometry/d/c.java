...
public final class c implements e {
    ...
    private static char[] f12577a = {'2', 'i', 'q', 'Z', 'V', 'l', 'm', 's', 'b', 'Y', 'U', '^', 'n', 'd', 'l', 't', 'n', 'l', 'n', 'i', 'i', 'r', 'o', 'm', 'p', 'n', 'm', '7', 'n', 'l', 'n', 'k', 'R', 'Z', 'v', 'n', 'i', '@', '~', '~', 128, 'i', '@', 'X', Ascii.MAX, 'w', 'w', '{', '|', '~', '{', '}', 128, 'g'};

    /* renamed from: d  reason: collision with root package name */
    private static int f12578d = 1;
    private static int e;
    @NotNull
    private final br.com.allowme.android.allowmesdk.f.b b;
    @NotNull
    private final e c;

    public c(@NotNull br.com.allowme.android.allowmesdk.f.b bVar, @NotNull e eVar) {
        Object[] objArr = new Object[1];
        b(false, "\u0001\u0001\u0000\u0001\u0001\u0000\u0001\u0000\u0000\u0000\u0000\u0001\u0001\u0000\u0000\u0001\u0001\u0000\u0001\u0001\u0001\u0000\u0001\u0001\u0001\u0001\u0001", new int[]{0, 27, 0, 19}, objArr);
        Intrinsics.checkNotNullParameter(bVar, ((String) objArr[0]).intern());
        Object[] objArr2 = new Object[1];
        b(true, "\u0000\u0001\u0000\u0001\u0001\u0000\u0001\u0000\u0001\u0001", new int[]{27, 10, 0, 0}, objArr2);
    ...
    */
    private static void b(boolean r12, java.lang.String r13, int[] r14, java.lang.Object[] r15) {
        ...
        L8:
            ...
            char[] r8 = br.com.allowme.android.allowmesdk.biometry.d.c.f12577a     // Catch: java.lang.Throwable -> L8b
        ...
        L8b:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: br.com.allowme.android.allowmesdk.biometry.d.c.b(boolean, java.lang.String, int[], java.lang.Object[]):void");
    }
    ...
    public final Object e(@NotNull List<String> list, @NotNull Continuation<? super BiometryResult> continuation) {
        if (!this.b.b().booleanValue()) {
            Object[] objArr = new Object[1];
            b(true, "\u0000\u0001\u0001\u0000\u0001\u0001\u0000\u0000\u0001\u0000\u0001\u0001\u0001\u0001\u0001\u0000\u0001", new int[]{37, 17, 14, 0}, objArr);
            throw new Exception(((String) objArr[0]).intern());
        }
        int i = f12578d + 77;
        e = i % 128;
        int i2 = i % 2;
        Object e2 = this.c.e(list, continuation);
        int i3 = e + 69;
        f12578d = i3 % 128;
        if (!(i3 % 2 == 0)) {
            return e2;
