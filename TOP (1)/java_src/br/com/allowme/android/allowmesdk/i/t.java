...
public final class t {
    ...
    @NotNull
    private final Object e$2054cf0f;

    public t(@NotNull Object obj, long j) {
        Object[] objArr = new Object[1];
        d(((Process.getThreadPriority(0) + 20) >> 6) + 19, false, 180 - (Process.getElapsedCpuTime() > 0L ? 1 : (Process.getElapsedCpuTime() == 0L ? 0 : -1)), 25 - Gravity.getAbsoluteGravity(0, 0), "\r\ufffa\ufff0\ufffe\ufffbￛ\u000b\b\u0010\f\ufffe\u000b￬\r\b\u000b\ufffa\u0000\ufffe\u0006\ufffe\r\ufffa�\ufffa", objArr);
    ...
    */
    private static void d(int r6, boolean r7, int r8, int r9, java.lang.String r10, java.lang.Object[] r11) {
        ...
        L10:
            ...
            int r5 = br.com.allowme.android.allowmesdk.i.t.b     // Catch: java.lang.Throwable -> L67
            int r4 = r4 - r5
            char r4 = (char) r4     // Catch: java.lang.Throwable -> L67
            r1[r3] = r4     // Catch: java.lang.Throwable -> L67
            int r3 = r3 + 1
        ...
        L67:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: br.com.allowme.android.allowmesdk.i.t.d(int, boolean, int, int, java.lang.String, java.lang.Object[]):void");
    }
}
