...
public final class AsyncStorageModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
    ...
    class b extends GuardedAsyncTask<Void, Void> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Callback f14142a;
        final /* synthetic */ ReadableArray b;
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            ...
            if (AsyncStorageModule.this.ensureDatabase()) {
                ...
                try {
                    try {
                        ...
                        for (int i = 0; i < this.b.size(); i++) {
                            if (this.b.getArray(i).size() != 2) {
                                ...
                                WritableMap c = com.reactnativecommunity.asyncstorage.b.c(null);
                                try {
                                    AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                                    return;
                                } catch (Exception e2) {
                    ...
                    WritableMap b = com.reactnativecommunity.asyncstorage.b.b(null, e6.getMessage());
                    try {
                        AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                    } catch (Exception e7) {
                        util.o7.a.G("ReactNative", e7.getMessage(), e7);
                        if (b == null) {
                            writableMap = com.reactnativecommunity.asyncstorage.b.b(null, e7.getMessage());
                        }
                    }
                    writableMap = b;
                }
                if (writableMap != null) {
                    this.f14142a.invoke(writableMap);
                    return;
                } else {
                    this.f14142a.invoke(new Object[0]);
                    return;
                }
            }
            this.f14142a.invoke(com.reactnativecommunity.asyncstorage.b.a(null));
        }
    }
                ...
                if (AsyncStorageModule.this.ensureDatabase()) {
                    try {
                        ...
                        for (int i = 0; i < this.b.size(); i += 999) {
                            ...
                            AsyncStorageModule.this.mReactDatabaseSupplier.L().delete("catalystLocalStorage", com.reactnativecommunity.asyncstorage.a.a(min), com.reactnativecommunity.asyncstorage.a.b(this.b, i, min));
                        }
                        AsyncStorageModule.this.mReactDatabaseSupplier.L().setTransactionSuccessful();
                        try {
                            AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                            ...
                            util.o7.a.G("ReactNative", e.getMessage(), e);
                            writableMap = com.reactnativecommunity.asyncstorage.b.b(null, e.getMessage());
                        }
                    } catch (Exception e2) {
                        util.o7.a.G("ReactNative", e2.getMessage(), e2);
                        WritableMap b = com.reactnativecommunity.asyncstorage.b.b(null, e2.getMessage());
                        try {
                            AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                        } catch (Exception e3) {
                            util.o7.a.G("ReactNative", e3.getMessage(), e3);
                            if (b == null) {
                                writableMap = com.reactnativecommunity.asyncstorage.b.b(null, e3.getMessage());
                            }
                        }
                        writableMap = b;
                    }
                    if (writableMap != null) {
                        this.f14143a.invoke(writableMap);
                        return;
                    } else {
                        this.f14143a.invoke(new Object[0]);
                        return;
                    }
                }
                this.f14143a.invoke(com.reactnativecommunity.asyncstorage.b.a(null));
            } catch (Throwable th) {
                try {
                    AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                } catch (Exception e4) {
    ...
    class d extends GuardedAsyncTask<Void, Void> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Callback f14144a;
        final /* synthetic */ ReadableArray b;
                ...
                if (AsyncStorageModule.this.ensureDatabase()) {
                    try {
                        ...
                        for (int i = 0; i < this.b.size(); i++) {
                            ...
                            } else if (!com.reactnativecommunity.asyncstorage.a.e(AsyncStorageModule.this.mReactDatabaseSupplier.L(), this.b.getArray(i).getString(0), this.b.getArray(i).getString(1))) {
                    ...
                    if (writableMap != null) {
                        this.f14144a.invoke(writableMap);
                        return;
                    } else {
                        this.f14144a.invoke(new Object[0]);
                        return;
                    }
                }
                this.f14144a.invoke(com.reactnativecommunity.asyncstorage.b.a(null));
            } catch (Throwable th) {
                try {
                    AsyncStorageModule.this.mReactDatabaseSupplier.L().endTransaction();
                } catch (Exception e8) {
                    util.o7.a.G("ReactNative", e8.getMessage(), e8);
                    com.reactnativecommunity.asyncstorage.b.b(null, e8.getMessage());
                }
                throw th;
            }
        }
    ...
    class e extends GuardedAsyncTask<Void, Void> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Callback f14145a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        e(ReactContext reactContext, Callback callback) {
            super(reactContext);
            this.f14145a = callback;
        }
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            if (AsyncStorageModule.this.mReactDatabaseSupplier.G()) {
                try {
                    ...
                    this.f14145a.invoke(new Object[0]);
                    return;
                } catch (Exception e) {
                    util.o7.a.G("ReactNative", e.getMessage(), e);
                    this.f14145a.invoke(com.reactnativecommunity.asyncstorage.b.b(null, e.getMessage()));
                    return;
                }
            }
            this.f14145a.invoke(com.reactnativecommunity.asyncstorage.b.a(null));
        }
    }
    ...
    class f extends GuardedAsyncTask<Void, Void> {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ Callback f14146a;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        f(ReactContext reactContext, Callback callback) {
            super(reactContext);
            this.f14146a = callback;
        }
        ...
        public void doInBackgroundGuarded(Void... voidArr) {
            if (!AsyncStorageModule.this.ensureDatabase()) {
                this.f14146a.invoke(com.reactnativecommunity.asyncstorage.b.a(null), null);
                return;
            }
            ...
            try {
                try {
                    if (query.moveToFirst()) {
                        ...
                        query.close();
                        this.f14146a.invoke(null, createArray);
                    }
                    query.close();
                    this.f14146a.invoke(null, createArray);
                } catch (Exception e) {
                    util.o7.a.G("ReactNative", e.getMessage(), e);
                    this.f14146a.invoke(com.reactnativecommunity.asyncstorage.b.b(null, e.getMessage()), null);
                    query.close();
                }
            } catch (Throwable th) {
                query.close();
    ...
    AsyncStorageModule(ReactApplicationContext reactApplicationContext, Executor executor) {
        ...
        this.mReactDatabaseSupplier = com.reactnativecommunity.asyncstorage.e.b0(reactApplicationContext);
    }
}
