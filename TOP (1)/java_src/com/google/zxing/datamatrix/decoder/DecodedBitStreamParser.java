...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', Typography.quote, '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', ',', '-', JwtParser.SEPARATOR_CHAR, '/', ':', ';', Typography.less, '=', Typography.greater, '?', '@', '[', '\\', ']', '^', '_'};
                ...
                if (i != 0) {
                    if (i != 1) {
                        if (i == 2) {
                            ...
                            if (z) {
                                sb.append((char) (i3 + PrimitiveTags.FREE_TEXT));
                                z = false;
                                i = 0;
                            } else {
