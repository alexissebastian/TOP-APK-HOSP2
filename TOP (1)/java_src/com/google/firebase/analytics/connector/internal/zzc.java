...
public final class zzc {
    ...
    private static final List<String> zzc = Arrays.asList(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, App.TYPE, "am");
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        conditionalUserProperty.active = ((Boolean) zzgr.zza(bundle, "active", Boolean.class, Boolean.FALSE)).booleanValue();
