...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    builder.setInternalKeys(parseArray(jsonReader, f.f13924a));
                    break;
                case 3:
                    builder.setCustomAttributes(parseArray(jsonReader, f.f13924a));
                    break;
                case 4:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    ...
                    break;
                case 1:
                    builder.setThreads(parseArray(jsonReader, c.f13921a));
                    break;
                case 2:
                    builder.setSignal(parseEventSignal(jsonReader));
                    break;
                case 3:
                    builder.setBinaries(parseArray(jsonReader, e.f13923a));
                    break;
                case 4:
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                case 0:
                    builder.setFrames(parseArray(jsonReader, b.f13920a));
                    break;
                case 1:
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(@NonNull JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (nextName.equals("files")) {
                builder.setFiles(parseArray(jsonReader, d.f13922a));
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    builder.setEvents(parseArray(jsonReader, a.f13919a));
                    break;
                case 5:
