...
public class BundleSerializer {
    ...
    private BundledQuery decodeBundledQuery(JSONObject jSONObject) throws JSONException {
        ...
        return new BundledQuery(new Target(decodeName, str, decodeWhere, decodeOrderBy, decodeLimit, decodeStartAtBound, decodeEndAtBound), decodeLimitType(jSONObject));
    }
