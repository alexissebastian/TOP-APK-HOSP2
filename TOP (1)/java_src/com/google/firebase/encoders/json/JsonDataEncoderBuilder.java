...
public final class JsonDataEncoderBuilder implements EncoderConfig<JsonDataEncoderBuilder> {
    private static final ObjectEncoder<Object> DEFAULT_FALLBACK_ENCODER = a.f13938a;
    private static final ValueEncoder<String> STRING_ENCODER = b.f13939a;
    private static final ValueEncoder<Boolean> BOOLEAN_ENCODER = c.f13940a;
