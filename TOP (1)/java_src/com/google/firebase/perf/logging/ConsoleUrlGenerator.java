...
public final class ConsoleUrlGenerator {
    ...
    public static String generateCustomTraceUrl(String str, String str2, String str3) {
        return String.format("%s/metrics/trace/DURATION_TRACE/%s?utm_source=%s&utm_medium=%s", getRootUrl(str, str2), str3, UTM_SOURCE, UTM_MEDIUM);
    }
    ...
    public static String generateScreenTraceUrl(String str, String str2, String str3) {
        return String.format("%s/metrics/trace/SCREEN_TRACE/%s?utm_source=%s&utm_medium=%s", getRootUrl(str, str2), str3, UTM_SOURCE, UTM_MEDIUM);
    }
