...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.on((char) JwtParser.SEPARATOR_CHAR);
    private static final Joiner DOT_JOINER = Joiner.on((char) JwtParser.SEPARATOR_CHAR);
    ...
    InternetDomainName(String str) {
        String lowerCase = Ascii.toLowerCase(DOTS_MATCHER.replaceFrom(str, JwtParser.SEPARATOR_CHAR));
