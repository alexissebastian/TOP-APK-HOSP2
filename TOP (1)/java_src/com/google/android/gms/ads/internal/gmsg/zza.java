...
public final class zza implements zzv<Object> {
            ...
            while (keys.hasNext()) {
                ...
                if (obj != null) {
                    if (obj instanceof Boolean) {
                        ...
                        zzane.zzdk(valueOf.length() != 0 ? "Unsupported type for key:".concat(valueOf) : new String("Unsupported type for key:"));
                    }
                }
            }
            return bundle;
    ...
    public final void zza(Object obj, Map<String, String> map) {
        ...
        if (zzar == null) {
            zzane.e("Failed to convert ad metadata to Bundle.");
        } else {
