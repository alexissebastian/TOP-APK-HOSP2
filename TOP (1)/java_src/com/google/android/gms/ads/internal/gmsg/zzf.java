...
public final class zzf {
    ...
    public static final /* synthetic */ void zza(zzue zzueVar, Map map) {
        ...
        try {
            ...
            zzane.zzdk(valueOf.length() != 0 ? "Unable to append parameter to URL: ".concat(valueOf) : new String("Unable to append parameter to URL: "));
        }
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(optString7)) {
                            try {
                                ...
                                zzane.zzb(valueOf.length() != 0 ? "Error parsing the url: ".concat(valueOf) : new String("Error parsing the url: "), e);
                            }
                        }
                        if (intent == null) {
                            intent = new Intent();
