...
public class SafeParcelWriter {
    ...
    public static void writeDouble(@NonNull Parcel parcel, int i, double d2) {
        zzc(parcel, i, 8);
    ...
    public static void writeDoubleObject(@NonNull Parcel parcel, int i, @NonNull Double d2, boolean z) {
        if (d2 != null) {
            zzc(parcel, i, 8);
