...
public final class zzhm implements zzhk {
    ...
    static {
        ...
        zza = zza2.zzb("getTokenRefactor__account_data_service_sample_percentage", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        ...
        try {
            ...
            zzn = zza2.zzb("getTokenRefactor__gms_account_authenticator_sample_percentage", FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
        } catch (zzew e) {
