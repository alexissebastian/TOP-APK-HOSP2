...
final class zzej implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzdlVar.zzb());
        objectEncoderContext2.add(zzc, zzdlVar.zzc());
        objectEncoderContext2.add(zzd, (Object) null);
        objectEncoderContext2.add(zze, zzdlVar.zza());
        objectEncoderContext2.add(zzf, zzdlVar.zzd());
        objectEncoderContext2.add(zzg, zzdlVar.zze());
    }
}
