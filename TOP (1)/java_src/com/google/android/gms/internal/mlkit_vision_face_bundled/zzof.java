...
final class zzof extends zzmv implements RandomAccess, zzos, zzqa {
    private static final zzof zza;
    private float[] zzb;
    private int zzc;

    static {
        zzof zzofVar = new zzof(new float[0], 0);
        zza = zzofVar;
        zzofVar.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ zzos zzd(int i) {
        if (i >= this.zzc) {
            return new zzof(Arrays.copyOf(this.zzb, i), this.zzc);
        }
