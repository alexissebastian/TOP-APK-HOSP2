...
public final class zzmk implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < validateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(readHeader)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    arrayList = SafeParcelReader.createTypedList(parcel, readHeader, zzmq.CREATOR);
                    break;
                case 11:
                    arrayList2 = SafeParcelReader.createTypedList(parcel, readHeader, zzmf.CREATOR);
                    break;
                default:
        ...
        return new zzmj(i, rect, f, f2, f3, f4, f5, f6, f7, arrayList, arrayList2);
    }
