...
final class zzfb implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zziqVar.zzc());
        objectEncoderContext2.add(zzc, zziqVar.zza());
        objectEncoderContext2.add(zzd, zziqVar.zzd());
        objectEncoderContext2.add(zze, zziqVar.zzb());
