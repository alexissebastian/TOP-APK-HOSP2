...
public class zzqr extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i = 0;
        if (size >= 0) {
            int compareTo = comparable.compareTo(((zzql) this.zzb.get(size)).zza());
            if (compareTo > 0) {
                return -(size + 2);
            }
            if (compareTo == 0) {
        ...
        while (i <= size) {
            int i2 = (i + size) / 2;
            int compareTo2 = comparable.compareTo(((zzql) this.zzb.get(i2)).zza());
            if (compareTo2 < 0) {
                size = i2 - 1;
    ...
    public final Object get(Object obj) {
        ...
        if (zzk >= 0) {
            return ((zzql) this.zzb.get(zzk)).getValue();
        }
    ...
    public final int hashCode() {
        ...
        for (int i2 = 0; i2 < zzb; i2++) {
            i += ((zzql) this.zzb.get(i2)).hashCode();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int zzk = zzk(comparable);
        if (zzk >= 0) {
            return ((zzql) this.zzb.get(zzk)).setValue(obj);
        }
        zzn();
