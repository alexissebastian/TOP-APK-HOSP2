...
final class zzrf {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_face_bundled.zzrf.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        zzre zzreVar = zzf;
        int zzj = zzreVar.zzj(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        zzreVar.zzn(obj, j2, ((255 & b) << i) | (zzj & (~(255 << i))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        zzre zzreVar = zzf;
        int i = (((int) j) & 3) << 3;
        zzreVar.zzn(obj, j2, ((255 & b) << i) | (zzreVar.zzj(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzrb());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzrf.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
