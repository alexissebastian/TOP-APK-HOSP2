...
public final class zzcv {
    ...
    public zzcv(Map<Class<?>, ObjectEncoder<?>> map, Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder) {
        this.zza = map;
        this.zzb = map2;
    ...
    public final byte[] zza(@NonNull Object obj) {
        ...
        try {
            new zzcs(byteArrayOutputStream, this.zza, this.zzb, this.zzc).zzf(obj);
