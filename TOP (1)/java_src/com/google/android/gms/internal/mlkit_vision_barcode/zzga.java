...
final class zzga implements ObjectEncoder<zziv> {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzivVar.zze());
        objectEncoderContext2.add(zzc, zzivVar.zza());
        objectEncoderContext2.add(zzd, zzivVar.zzd());
        objectEncoderContext2.add(zze, zzivVar.zzb());
        objectEncoderContext2.add(zzf, zzivVar.zzc());
