...
public final class zzaq {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0 || i >= i2) {
            if (i < 0) {
                ...
                zza = zzar.zza("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
            }
    ...
    public static void zzc(int i, int i2, int i3) {
        ...
        if (i < 0 || i2 < i || i2 > i3) {
            if (i >= 0 && i <= i3) {
                zze = (i2 < 0 || i2 > i3) ? zze(i2, i3, "end index") : zzar.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i));
            } else {
