...
final class zzdi<E> extends zzao<E> implements RandomAccess {
    private static final zzdi<Object> zza;
    private E[] zzb;
    private int zzc;

    static {
        zzdi<Object> zzdiVar = new zzdi<>(new Object[0], 0);
        zza = zzdiVar;
        zzdiVar.zzb();
    }
    ...
    public final /* bridge */ /* synthetic */ zzcb zze(int i) {
        if (i >= this.zzc) {
            return new zzdi(Arrays.copyOf(this.zzb, i), this.zzc);
        }
        throw new IllegalArgumentException();
    }

    private zzdi(E[] eArr, int i) {
        this.zzb = eArr;
        this.zzc = i;
    }
