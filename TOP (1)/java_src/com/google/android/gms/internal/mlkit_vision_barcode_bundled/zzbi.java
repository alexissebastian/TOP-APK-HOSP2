...
final class zzbi {
    ...
    private zzbi(zzbh zzbhVar) {
        zzcc.zzf(zzbhVar, "output");
        this.zza = zzbhVar;
        zzbhVar.zza = this;
    }

    public static zzbi zza(zzbh zzbhVar) {
        zzbi zzbiVar = zzbhVar.zza;
        return zzbiVar != null ? zzbiVar : new zzbi(zzbhVar);
    }
    ...
    public final void zzA(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzbh.zzA((intValue >> 31) ^ (intValue + intValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zzbh zzbhVar = this.zza;
                int intValue2 = list.get(i2).intValue();
                zzbhVar.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzbhVar2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzC(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            for (int i4 = 0; i4 < list.size(); i4++) {
                ...
                i3 += zzbh.zzB((longValue >> 63) ^ (longValue + longValue));
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
                zzbh zzbhVar = this.zza;
                long longValue2 = list.get(i2).longValue();
                zzbhVar.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzbhVar2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
    ...
    public final void zzG(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzbh.zzA(list.get(i4).intValue());
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
    ...
    public final void zzI(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzbh.zzB(list.get(i4).longValue());
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
    ...
    public final void zze(int i, List<zzba> list) throws IOException {
    ...
    public final void zzi(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            int i3 = 0;
            for (int i4 = 0; i4 < list.size(); i4++) {
                i3 += zzbh.zzv(list.get(i4).intValue());
            }
            this.zza.zzq(i3);
            while (i2 < list.size()) {
    ...
    public final void zzp(int i, Object obj, zzdk zzdkVar) throws IOException {
        zzbh zzbhVar = this.zza;
        zzbhVar.zzo(i, 3);
        zzdkVar.zzh((zzcz) obj, zzbhVar.zza);
        zzbhVar.zzo(i, 4);
    }
    ...
    public final void zzu(int i, Object obj, zzdk zzdkVar) throws IOException {
        ...
        int zzc = zzanVar.zzc();
        if (zzc == -1) {
            zzc = zzdkVar.zza(zzanVar);
            zzanVar.zze(zzc);
        }
        zzbfVar.zzq(zzc);
        zzdkVar.zzh(zzczVar, zzbfVar.zza);
    }
