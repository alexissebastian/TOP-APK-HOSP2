...
final class zzeh {
    ...
    static {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_barcode_bundled.zzeh.<clinit>():void");
    }
    ...
    public static void zzD(Object obj, long j, byte b) {
        long j2 = (-4) & j;
        zzeg zzegVar = zzg;
        int zzj = zzegVar.zzj(obj, j2);
        int i = ((~((int) j)) & 3) << 3;
        zzegVar.zzn(obj, j2, ((255 & b) << i) | (zzj & (~(255 << i))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        zzeg zzegVar = zzg;
        int i = (((int) j) & 3) << 3;
        zzegVar.zzn(obj, j2, ((255 & b) << i) | (zzegVar.zzj(obj, j2) & (~(255 << i))));
    }
    ...
    public static Unsafe zzg() {
        try {
            return (Unsafe) AccessController.doPrivileged(new zzed());
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    static /* synthetic */ void zzh(Throwable th) {
        Logger logger = Logger.getLogger(zzeh.class.getName());
