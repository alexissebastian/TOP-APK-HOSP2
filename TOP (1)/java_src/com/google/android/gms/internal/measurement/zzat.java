    ...
    public final zzap zzbK(String str, zzg zzgVar, List<zzap> list) {
        ...
        switch (c) {
            ...
            case 5:
                ...
                Matcher matcher2 = Pattern.compile(list.size() > 0 ? zzgVar.zzb(list.get(0)).zzi() : "").matcher(this.zza);
            ...
            case '\b':
                ...
                double zza2 = zzh.zza(list.size() > 0 ? zzgVar.zzb(list.get(0)).zzh().doubleValue() : FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                if (zza2 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                    min = Math.max(str12.length() + zza2, (double) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                } else {
                ...
                if (zza3 < FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE) {
                    min2 = Math.max(str12.length() + zza3, (double) FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                } else {
