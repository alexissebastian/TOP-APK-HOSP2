...
public final class zznh implements zzng {
    ...
    static {
        ...
        zza = zzhrVar.zzc("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        ...
        zzf = zzhrVar.zzd("measurement.config.url_scheme", ProxyConfig.MATCH_HTTPS);
        ...
        zzl = zzhrVar.zzc("measurement.alarm_manager.minimum_interval", ExponentialBackoff.DEFAULT_BACKOFF_MAX_DELAY_MS);
        ...
        zzo = zzhrVar.zzc("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
