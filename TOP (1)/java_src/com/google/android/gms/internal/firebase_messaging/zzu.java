...
public final class zzu implements ObjectEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzu zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzu zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzs zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzu zzf(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder<?> objectEncoder = this.zzf.get(obj.getClass());
