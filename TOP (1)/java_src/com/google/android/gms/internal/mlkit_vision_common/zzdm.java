...
final class zzdm implements ObjectEncoder {
    ...
    public final /* bridge */ /* synthetic */ void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
        ...
        objectEncoderContext2.add(zzb, zzguVar.zzg());
        objectEncoderContext2.add(zzc, zzguVar.zzb());
        objectEncoderContext2.add(zzd, zzguVar.zza());
        objectEncoderContext2.add(zze, zzguVar.zzc());
        objectEncoderContext2.add(zzf, zzguVar.zze());
        objectEncoderContext2.add(zzg, zzguVar.zzd());
        objectEncoderContext2.add(zzh, zzguVar.zzf());
    }
}
