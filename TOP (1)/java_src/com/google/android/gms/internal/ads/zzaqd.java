...
public final class zzaqd implements com.google.android.gms.ads.internal.gmsg.zzv<zzapw> {
    ...
    public final /* synthetic */ void zza(zzapw zzapwVar, Map map) {
        ...
        if (((Boolean) zzkb.zzik().zzd(zznk.zzbae)).booleanValue()) {
            ...
            if (zztm == null) {
                try {
                    zzarl zzarlVar = new zzarl(zzapwVar2, Float.parseFloat((String) map.get(TypedValues.TransitionType.S_DURATION)), "1".equals(map.get("customControlsAllowed")), "1".equals(map.get("clickToExpandAllowed")));
