...
final class zzazk {
    ...
    public static byte[] zze(byte[] bArr, byte[] bArr2) {
        if (bArr.length == 32) {
            ...
            long zzd = (((j34 << 26) | j33) & 4294967295L) + zzd(bArr, 16);
            long j38 = zzd & 4294967295L;
            long zzd2 = (((j34 >> 6) | (j35 << 20)) & 4294967295L) + zzd(bArr, 20) + (zzd >> 32);
            long zzd3 = (((j35 >> 12) | (j36 << 14)) & 4294967295L) + zzd(bArr, 24) + (zzd2 >> 32);
            byte[] bArr4 = new byte[16];
            zza(bArr4, j38, 0);
            zza(bArr4, zzd2 & 4294967295L, 4);
            zza(bArr4, zzd3 & 4294967295L, 8);
            zza(bArr4, (((j37 | (j36 >> 18)) & 4294967295L) + zzd(bArr, 28) + (zzd3 >> 32)) & 4294967295L, 12);
            return bArr4;
        }
