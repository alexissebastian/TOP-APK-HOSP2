...
public final class zzaiy {
    ...
    private static Bundle zza(Context context, String str, boolean z) {
        ...
        try {
            ...
            zzane.zzb(valueOf.length() != 0 ? "Invalid event ID: ".concat(valueOf) : new String("Invalid event ID: "), e);
        }
        if (z) {
            bundle.putInt("_r", 1);
        }
    ...
    public final String zzaa(final Context context) {
        if (zzs(context)) {
            ...
            if (this.zzcnp.get() == null) {
                ...
                zzna<Integer> zznaVar = zznk.zzaxu;
                atomicReference.compareAndSet(null, new ThreadPoolExecutor(((Integer) zzkb.zzik().zzd(zznaVar)).intValue(), ((Integer) zzkb.zzik().zzd(zznaVar)).intValue(), 1L, TimeUnit.MINUTES, new LinkedBlockingQueue(), new zzaja(this)));
            }
