...
public final class zzoj extends zzpt {
    ...
    static {
        int rgb = Color.rgb(12, 174, (int) MlKitException.CODE_SCANNER_PIPELINE_INFERENCE_ERROR);
        zzbha = rgb;
        int rgb2 = Color.rgb((int) MlKitException.CODE_SCANNER_TASK_IN_PROGRESS, (int) MlKitException.CODE_SCANNER_TASK_IN_PROGRESS, (int) MlKitException.CODE_SCANNER_TASK_IN_PROGRESS);
        zzbhb = rgb2;
        zzbhc = rgb2;
        zzbhd = rgb;
    }
