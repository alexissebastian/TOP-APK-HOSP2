...
public final class zzyk extends zzxr {
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjj zzjjVar, String str, String str2, zzxt zzxtVar) throws RemoteException {
        ...
        try {
            ...
            zzyj zzyjVar = new zzyj(zzjjVar.zzapw == -1 ? null : new Date(zzjjVar.zzapw), zzjjVar.zzapx, zzjjVar.zzapy != null ? new HashSet(zzjjVar.zzapy) : null, zzjjVar.zzaqe, zzm(zzjjVar), zzjjVar.zzaqa, zzjjVar.zzaql);
            Bundle bundle = zzjjVar.zzaqg;
            mediationInterstitialAdapter.requestInterstitialAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzyl(zzxtVar), zza(str, zzjjVar, str2), zzyjVar, bundle != null ? bundle.getBundle(mediationInterstitialAdapter.getClass().getName()) : null);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjj zzjjVar, String str, String str2, zzxt zzxtVar, zzpl zzplVar, List<String> list) throws RemoteException {
        ...
        try {
            ...
            mediationNativeAdapter.requestNativeAd((Context) ObjectWrapper.unwrap(iObjectWrapper), this.zzbut, zza(str, zzjjVar, str2), zzyoVar, bundle2);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
    ...
    public final void zza(IObjectWrapper iObjectWrapper, zzjn zzjnVar, zzjj zzjjVar, String str, String str2, zzxt zzxtVar) throws RemoteException {
        ...
        try {
            ...
            zzyj zzyjVar = new zzyj(zzjjVar.zzapw == -1 ? null : new Date(zzjjVar.zzapw), zzjjVar.zzapx, zzjjVar.zzapy != null ? new HashSet(zzjjVar.zzapy) : null, zzjjVar.zzaqe, zzm(zzjjVar), zzjjVar.zzaqa, zzjjVar.zzaql);
            Bundle bundle = zzjjVar.zzaqg;
            mediationBannerAdapter.requestBannerAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzyl(zzxtVar), zza(str, zzjjVar, str2), com.google.android.gms.ads.zzb.zza(zzjnVar.width, zzjnVar.height, zzjnVar.zzarb), zzyjVar, bundle != null ? bundle.getBundle(mediationBannerAdapter.getClass().getName()) : null);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
    ...
    public final void zza(zzjj zzjjVar, String str, String str2) throws RemoteException {
        ...
        try {
            ...
            zzyj zzyjVar = new zzyj(zzjjVar.zzapw == -1 ? null : new Date(zzjjVar.zzapw), zzjjVar.zzapx, zzjjVar.zzapy != null ? new HashSet(zzjjVar.zzapy) : null, zzjjVar.zzaqe, zzm(zzjjVar), zzjjVar.zzaqa, zzjjVar.zzaql);
            Bundle bundle = zzjjVar.zzaqg;
            mediationRewardedVideoAdAdapter.loadAd(zzyjVar, zza(str, zzjjVar, str2), bundle != null ? bundle.getBundle(mediationRewardedVideoAdAdapter.getClass().getName()) : null);
        } catch (Throwable th) {
            zzane.zzb("", th);
            throw new RemoteException();
        }
