...
public final class zzapi extends FrameLayout implements zzapf {
    ...
    public final void zzg(String str, @Nullable String str2) {
        zza(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "what", str, "extra", str2);
    }
    ...
    public final void zzsv() {
        ...
        if (zzapgVar != null && this.zzcxx == 0) {
            zza("canplaythrough", TypedValues.TransitionType.S_DURATION, String.valueOf(zzapgVar.getDuration() / 1000.0f), "videoWidth", String.valueOf(this.zzcxr.getVideoWidth()), "videoHeight", String.valueOf(this.zzcxr.getVideoHeight()));
        }
    }
