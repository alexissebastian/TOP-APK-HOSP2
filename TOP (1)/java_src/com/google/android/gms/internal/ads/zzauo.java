...
public final class zzauo {
    ...
    public static synchronized <P> void zza(String str, zzaua<P> zzauaVar) throws GeneralSecurityException {
        synchronized (zzauo.class) {
            ConcurrentMap<String, zzaua> concurrentMap = zzdhs;
            if (concurrentMap.containsKey(str.toLowerCase()) && !zzauaVar.getClass().equals(concurrentMap.get(str.toLowerCase()).getClass())) {
            ...
            concurrentMap.put(str.toLowerCase(), zzauaVar);
        }
    }
    ...
    public static synchronized <P> void zza(String str, zzaug<P> zzaugVar, boolean z) throws GeneralSecurityException {
        synchronized (zzauo.class) {
            ...
            ConcurrentMap<String, zzaug> concurrentMap = zzdhq;
            ...
            concurrentMap.put(str, zzaugVar);
