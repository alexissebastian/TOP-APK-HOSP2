...
public final class zzfp implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    public zzfp(Context context, View view) {
        ...
        this.zzaeo = applicationContext;
        WindowManager windowManager = (WindowManager) context.getSystemService("window");
        this.zzaeu = windowManager;
        this.zzaev = (PowerManager) applicationContext.getSystemService("power");
        this.zzaew = (KeyguardManager) context.getSystemService("keyguard");
        if (applicationContext instanceof Application) {
            this.zzagd = (Application) applicationContext;
            this.zzagg = new zzfu((Application) applicationContext, this);
        }
    ...
    private final void zzf(View view) {
        try {
            WeakReference<ViewTreeObserver> weakReference = this.zzage;
        ...
        if (this.zzafe != null) {
            try {
                ...
                zzane.zzb("Failed trying to unregister the receiver", e3);
            } catch (Exception e4) {
        ...
        if (application != null) {
            try {
                ...
                zzane.zzb("Error registering activity lifecycle callbacks.", e5);
            }
        }
    }
