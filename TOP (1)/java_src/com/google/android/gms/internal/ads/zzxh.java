    ...
    public final zzxe zzh(List<zzwx> list) {
        ...
        while (it.hasNext()) {
            ...
            for (Iterator<String> it2 = next.zzbrt.iterator(); it2.hasNext(); it2 = it2) {
                ...
                zzxb zzxbVar = new zzxb(context, it2.next(), zzxnVar, zzwyVar, next, zzaefVar.zzccv, zzjnVar, zzaefVar.zzacr, this.zzael, this.zzbtn, zzaefVar.zzadj, zzaefVar.zzads, zzaefVar.zzcdk, zzaefVar.zzcef, this.zzbto);
