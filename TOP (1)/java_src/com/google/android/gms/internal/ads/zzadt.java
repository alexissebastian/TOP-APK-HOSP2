...
final class zzadt implements Runnable {
    ...
    public final void run() {
        ...
        synchronized (obj) {
            ...
            zzaegVar = zzadkVar.zzccg;
            zzadkVar.zzccj = zzadkVar.zza(zzaegVar.zzacr, this.zzcco);
            zzadk zzadkVar2 = this.zzccn;
            if (zzadkVar2.zzccj == null) {
                zzadkVar2.zzc(0, "Could not start the ad request service.");
