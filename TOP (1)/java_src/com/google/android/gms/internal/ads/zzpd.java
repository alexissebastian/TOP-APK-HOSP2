...
public class zzpd implements zzoz {
    ...
    public final void performClick(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.e("The ad slot cannot handle external click events. You must be whitelisted to be able to report your click events.");
        }
    }
    ...
    public final boolean recordImpression(Bundle bundle) {
        ...
        zzane.e("The ad slot cannot handle external impression events. You must be whitelisted to whitelisted to be able to report your impression events.");
        return false;
    }
    ...
    public final void reportTouchEvent(Bundle bundle) {
        if (bundle == null) {
            ...
            zzane.e("The ad slot cannot handle external touch events. You must be whitelisted to be able to report your touch events.");
        } else {
