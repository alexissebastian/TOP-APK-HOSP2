...
public final class zzbl implements ObjectEncoderContext {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public zzbl(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzbj zzbjVar = (zzbj) fieldDescriptor.getProperty(zzbj.class);
        if (zzbjVar != null) {
            return zzbjVar.zza();
        }
    ...
    private static zzbj zzj(FieldDescriptor fieldDescriptor) {
        zzbj zzbjVar = (zzbj) fieldDescriptor.getProperty(zzbj.class);
        if (zzbjVar != null) {
            return zzbjVar;
        }
    ...
    private final zzbl zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzbl zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    public final ObjectEncoderContext zzc(@NonNull FieldDescriptor fieldDescriptor, @Nullable Object obj, boolean z) throws IOException {
        ...
        if (obj instanceof CharSequence) {
            ...
            if (valueEncoder != null) {
                ...
                zzd(fieldDescriptor, ((zzbh) obj).zza(), true);
                return this;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbl zzd(@NonNull FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
        zzbj zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbl zze(@NonNull FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        zzbj zzj = zzj(fieldDescriptor);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final zzbl zzf(@Nullable Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
