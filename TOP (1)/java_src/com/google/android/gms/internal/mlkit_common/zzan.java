...
public abstract class zzan extends zzaj implements List, RandomAccess {
    private static final zzba zza = new zzal(zzas.zza, 0);
    ...
    public static zzan zzh(Object[] objArr) {
        return zzi(objArr, objArr.length);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static zzan zzi(Object[] objArr, int i) {
        if (i == 0) {
            return zzas.zza;
        }
    ...
    @Override // java.util.List
    /* renamed from: zzf */
    public zzan subList(int i, int i2) {
        zzac.zzc(i, i2, size());
        int i3 = i2 - i;
        if (i3 == size()) {
            return this;
    ...
    public final zzba listIterator(int i) {
        ...
        return isEmpty() ? zza : new zzal(this, i);
    }
}
