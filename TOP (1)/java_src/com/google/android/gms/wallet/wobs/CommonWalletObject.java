...
public class CommonWalletObject extends AbstractSafeParcelable {
    ...
    public final class zza {
        ...
        public final zza zzb(String str) {
            CommonWalletObject.this.zzco = str;
            return this;
        }
        ...
        public final zza zzj(String str) {
            CommonWalletObject.this.zzct = str;
            return this;
        }
        ...
        public final zza zzf(Collection<UriData> collection) {
            CommonWalletObject.this.zzcy.addAll(collection);
            return this;
        }

        public final zza zza(WalletObjectMessage walletObjectMessage) {
            CommonWalletObject.this.zzcp.add(walletObjectMessage);
            return this;
        }

        public final zza zzb(UriData uriData) {
            CommonWalletObject.this.zzcy.add(uriData);
            return this;
        }

        public final zza zzc(Collection<LabelValueRow> collection) {
            CommonWalletObject.this.zzcu.addAll(collection);
            return this;
        }
        ...
        public final zza zza(TimeInterval timeInterval) {
            CommonWalletObject.this.zzcq = timeInterval;
            return this;
        }

        public final zza zza(LatLng latLng) {
            CommonWalletObject.this.zzcr.add(latLng);
            return this;
        }

        public final zza zza(LabelValueRow labelValueRow) {
            CommonWalletObject.this.zzcu.add(labelValueRow);
            return this;
        }

        public final zza zza(boolean z) {
            CommonWalletObject.this.zzcv = z;
            return this;
        }

        public final zza zza(UriData uriData) {
            CommonWalletObject.this.zzcw.add(uriData);
            return this;
        }

        public final zza zza(TextModuleData textModuleData) {
            CommonWalletObject.this.zzcx.add(textModuleData);
            return this;
        }
    }
