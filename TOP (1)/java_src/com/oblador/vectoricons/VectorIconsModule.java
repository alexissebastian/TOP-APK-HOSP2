...
public class VectorIconsModule extends ReactContextBaseJavaModule {
    ...
    protected String createGlyphImagePath(String str, String str2, Integer num, Integer num2) throws IOException, FileNotFoundException {
        ...
        String str4 = str3 + Integer.toString((str + OobNotificationProfile.SEPERATOR + str2 + OobNotificationProfile.SEPERATOR + num2).hashCode(), 32) + "_" + Integer.toString(num.intValue()) + sb2 + ".png";
        ...
        Typeface c = j.b().c(str, 0, reactApplicationContext.getAssets());
