...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public class AnonymousClass1 implements Runnable {
                    ...
                    public void run() {
                        AsyncTask.execute(new Runnable() { // from class: com.facebook.react.bridge.CatalystInstanceImpl.1.1.1.1
                            ...
                            public void run() {
                                ...
                                util.o7.a.b("ReactNative", "CatalystInstanceImpl.destroy() end");
        ...
        public void run() {
            ...
            CatalystInstanceImpl.this.getReactQueueConfiguration().getJSQueueThread().runOnQueue(new RunnableC00711());
        }
    }
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            ...
            util.i9.a.c(reactQueueConfigurationSpec);
            ...
            util.i9.a.c(nativeModuleCallExceptionHandler);
    ...
    private TurboModuleRegistry getTurboModuleRegistry() {
        if (util.m9.a.f15334a) {
            TurboModuleRegistry turboModuleRegistry = this.mTurboModuleRegistry;
            util.i9.a.d(turboModuleRegistry, "TurboModules are enabled, but mTurboModuleRegistry hasn't been set.");
    ...
    @Override // com.facebook.react.bridge.CatalystInstance
    public void destroy() {
        util.o7.a.b("ReactNative", "CatalystInstanceImpl.destroy() start");
    ...
    public void initialize() {
        util.o7.a.b("ReactNative", "CatalystInstanceImpl.initialize()");
        util.i9.a.b(!this.mInitialized, "This catalyst instance has already been initialized");
        util.i9.a.b(this.mAcceptCalls, "RunJSBundle hasn't completed.");
    ...
    public void invokeCallback(int i, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            util.o7.a.F("ReactNative", "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public void runJSBundle() {
        util.o7.a.b("ReactNative", "CatalystInstanceImpl.runJSBundle()");
        util.i9.a.b(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, NativeModuleCallExceptionHandler nativeModuleCallExceptionHandler) {
        ...
        util.o7.a.b("ReactNative", "Initializing React Xplat Bridge.");
        ...
        util.o7.a.b("ReactNative", "Initializing React Xplat Bridge before initializeBridge");
        ...
        util.o7.a.b("ReactNative", "Initializing React Xplat Bridge after initializeBridge");
        com.facebook.systrace.a.g(0L);
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            ...
            util.o7.a.F("ReactNative", "Calling JS function after bridge has been destroyed: " + pendingJSCall2);
            return;
        }
