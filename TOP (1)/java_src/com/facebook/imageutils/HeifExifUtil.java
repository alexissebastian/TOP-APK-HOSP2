...
public class HeifExifUtil {
    ...
    private static class HeifExifUtilAndroidN {
        ...
        static int a(InputStream inputStream) {
            try {
                ...
                util.o7.a.d("HeifExifUtil", "Failed reading Heif Exif orientation -> ignoring", e);
                return 0;
            }
        }
    }
    ...
    public static int a(InputStream inputStream) {
        ...
        util.o7.a.b("HeifExifUtil", "Trying to read Heif Exif information before Android N -> ignoring");
        return 0;
    }
}
