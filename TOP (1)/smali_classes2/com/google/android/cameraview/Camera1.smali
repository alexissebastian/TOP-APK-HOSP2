...
.method private chooseCamera()V
    ...
    .line 7
    iget-object v4, p0, Lcom/google/android/cameraview/Camera1;->mCameraInfo:Landroid/hardware/Camera$CameraInfo;
    ...
    iget v5, p0, Lcom/google/android/cameraview/Camera1;->mFacing:I
...
.method private setPlaySoundInternal(Z)V
    ...
    .line 3
    :try_start_0
    invoke-virtual {p1, v1}, Landroid/hardware/Camera;->enableShutterSound(Z)Z
...
.method private updateSurface()V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/cameraview/CameraViewImpl;->mBgHandler:Landroid/os/Handler;
...
.method adjustCameraParameters()V
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/cameraview/SizeMap;->sizes(Lcom/google/android/cameraview/AspectRatio;)Ljava/util/SortedSet;
    ...
    iget-object v4, p0, Lcom/google/android/cameraview/Camera1;->mPictureSizes:Lcom/google/android/cameraview/SizeMap;

    iget-object v5, p0, Lcom/google/android/cameraview/Camera1;->mAspectRatio:Lcom/google/android/cameraview/AspectRatio;

    .line 8
    invoke-virtual {v4, v5}, Lcom/google/android/cameraview/SizeMap;->sizes(Lcom/google/android/cameraview/AspectRatio;)Ljava/util/SortedSet;

    move-result-object v4

    .line 9
    invoke-direct {p0, v1, v3, v4}, Lcom/google/android/cameraview/Camera1;->getBestSizeMatch(IILjava/util/SortedSet;)Lcom/google/android/cameraview/Size;
    ...
    .line 11
    invoke-virtual {v1, v3}, Lcom/google/android/cameraview/SizeMap;->sizes(Lcom/google/android/cameraview/AspectRatio;)Ljava/util/SortedSet;

    move-result-object v1

    .line 12
    invoke-direct {p0, v2, v2, v1}, Lcom/google/android/cameraview/Camera1;->getBestSizeMatch(IILjava/util/SortedSet;)Lcom/google/android/cameraview/Size;

    move-result-object v1

    .line 13
    :goto_0
    iget-boolean v3, p0, Lcom/google/android/cameraview/Camera1;->mIsPreviewActive:Z

    if-eqz v3, :cond_2

    .line 14
    iget-object v4, p0, Lcom/google/android/cameraview/Camera1;->mCamera:Landroid/hardware/Camera;
    ...
    invoke-virtual {v0, v2, v2}, Landroid/hardware/Camera$Parameters;->setJpegThumbnailSize(II)V
    ...
    iget v1, p0, Lcom/google/android/cameraview/Camera1;->mDeviceOrientation:I
...
.method record(Ljava/lang/String;IIZLandroid/media/CamcorderProfile;II)Z
    ...
    .line 1
    iget-object v1, v7, Lcom/google/android/cameraview/Camera1;->isPictureCaptureInProgress:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v1, v7, Lcom/google/android/cameraview/Camera1;->mIsRecording:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 2
    iput v0, v7, Lcom/google/android/cameraview/Camera1;->mOrientation:I
    ...
    .line 3
    :try_start_0
    invoke-direct/range {v0 .. v6}, Lcom/google/android/cameraview/Camera1;->setUpMediaRecorder(Ljava/lang/String;IIZLandroid/media/CamcorderProfile;I)V

    .line 4
    iget-object v0, v7, Lcom/google/android/cameraview/Camera1;->mMediaRecorder:Landroid/media/MediaRecorder;
    ...
    .line 6
    :try_start_1
    iget-object v0, v7, Lcom/google/android/cameraview/Camera1;->mCamera:Landroid/hardware/Camera;

    iget-object v1, v7, Lcom/google/android/cameraview/Camera1;->mCameraParameters:Landroid/hardware/Camera$Parameters;
    ...
    :catch_0
    :try_start_2
    iget v0, v7, Lcom/google/android/cameraview/Camera1;->mDeviceOrientation:I
    ...
    .line 8
    iget-object v1, v7, Lcom/google/android/cameraview/CameraViewImpl;->mCallback:Lcom/google/android/cameraview/CameraViewImpl$Callback;

    iget v2, v7, Lcom/google/android/cameraview/Camera1;->mOrientation:I
    ...
    .line 9
    iget-object v0, v7, Lcom/google/android/cameraview/Camera1;->mPlaySoundOnRecord:Ljava/lang/Boolean;
    ...
    .line 10
    iget-object v0, v7, Lcom/google/android/cameraview/Camera1;->sound:Landroid/media/MediaActionSound;
    ...
    .line 11
    :catch_1
    iget-object v0, v7, Lcom/google/android/cameraview/Camera1;->mIsRecording:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method setAspectRatio(Lcom/google/android/cameraview/AspectRatio;)Z
    ...
    .line 5
    iget-object p1, p0, Lcom/google/android/cameraview/CameraViewImpl;->mBgHandler:Landroid/os/Handler;
