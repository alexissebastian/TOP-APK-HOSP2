...
# virtual methods
.method public c(Landroid/graphics/Bitmap;Lutil/v8/f;)Lcom/facebook/common/references/a;
    .locals 8
    ...
    invoke-static {v0}, Lcom/facebook/react/views/image/h;->i(Lcom/facebook/react/views/image/h;)Lutil/l8/q$b;

    move-result-object v0

    .line 3
    invoke-static {}, Lcom/facebook/react/views/image/h;->m()Landroid/graphics/Matrix;
    ...
    .line 4
    invoke-interface/range {v0 .. v6}, Lutil/l8/q$b;->a(Landroid/graphics/Matrix;Landroid/graphics/Rect;IIFF)Landroid/graphics/Matrix;
    ...
    invoke-static {v2}, Lcom/facebook/react/views/image/h;->n(Lcom/facebook/react/views/image/h;)Landroid/graphics/Shader$TileMode;

    move-result-object v2

    iget-object v3, p0, Lcom/facebook/react/views/image/h$c;->c:Lcom/facebook/react/views/image/h;

    invoke-static {v3}, Lcom/facebook/react/views/image/h;->n(Lcom/facebook/react/views/image/h;)Landroid/graphics/Shader$TileMode;
    ...
    invoke-virtual {p2, p1, v1}, Lutil/v8/f;->a(II)Lcom/facebook/common/references/a;
