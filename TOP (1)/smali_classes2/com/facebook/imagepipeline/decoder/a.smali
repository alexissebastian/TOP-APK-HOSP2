...
.method public a(Lutil/b9/d;ILutil/b9/i;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/b;
    ...
    .line 2
    invoke-interface {v0, p1, p2, p3, p4}, Lcom/facebook/imagepipeline/decoder/b;->a(Lutil/b9/d;ILutil/b9/i;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/b;
    ...
    .line 6
    invoke-static {v1}, Lutil/s8/d;->c(Ljava/io/InputStream;)Lutil/s8/c;

    move-result-object v0

    .line 7
    invoke-virtual {p1, v0}, Lutil/b9/d;->x0(Lutil/s8/c;)V
...
.method public b(Lutil/b9/d;ILutil/b9/i;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/b;
    .locals 1
...
.method public c(Lutil/b9/d;ILutil/b9/i;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/b;
    .locals 2
    ...
    .line 5
    :cond_0
    invoke-virtual {p0, p1, p4}, Lcom/facebook/imagepipeline/decoder/a;->e(Lutil/b9/d;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/c;
...
.method public d(Lutil/b9/d;ILutil/b9/i;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/c;
    .locals 6
    ...
    .line 2
    invoke-interface/range {v0 .. v5}, Lcom/facebook/imagepipeline/platform/d;->a(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;

    move-result-object p2

    .line 3
    :try_start_0
    iget-object v0, p4, Lcom/facebook/imagepipeline/common/b;->j:Lutil/h9/a;

    .line 4
    invoke-static {v0, p2}, Lutil/h9/b;->a(Lutil/h9/a;Lcom/facebook/common/references/a;)Z

    move-result v0

    .line 5
    new-instance v1, Lutil/b9/c;
    ...
    invoke-direct {v1, p2, p3, v2, p1}, Lutil/b9/c;-><init>(Lcom/facebook/common/references/a;Lutil/b9/i;II)V
    ...
    .line 8
    iget-object p3, p4, Lcom/facebook/imagepipeline/common/b;->j:Lutil/h9/a;
    ...
    .line 10
    invoke-virtual {v1, p1, p3}, Lutil/b9/b;->z(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
...
.method public e(Lutil/b9/d;Lcom/facebook/imagepipeline/common/b;)Lutil/b9/c;
    .locals 5
    ...
    .line 2
    invoke-interface {v0, p1, v1, v3, v2}, Lcom/facebook/imagepipeline/platform/d;->b(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;

    move-result-object v0

    .line 3
    :try_start_0
    iget-object v1, p2, Lcom/facebook/imagepipeline/common/b;->j:Lutil/h9/a;

    .line 4
    invoke-static {v1, v0}, Lutil/h9/b;->a(Lutil/h9/a;Lcom/facebook/common/references/a;)Z

    move-result v1

    .line 5
    new-instance v2, Lutil/b9/c;
    ...
    invoke-direct {v2, v0, v3, v4, p1}, Lutil/b9/c;-><init>(Lcom/facebook/common/references/a;Lutil/b9/i;II)V
    ...
    .line 8
    iget-object p2, p2, Lcom/facebook/imagepipeline/common/b;->j:Lutil/h9/a;
    ...
    .line 10
    invoke-virtual {v2, p1, p2}, Lutil/b9/b;->z(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
