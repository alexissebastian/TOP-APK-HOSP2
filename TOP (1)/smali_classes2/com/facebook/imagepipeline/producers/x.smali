...
.method public constructor <init>(I)V
    ...
    invoke-direct {p0, v1, v1, v0}, Lcom/facebook/imagepipeline/producers/x;-><init>(Ljava/lang/String;Ljava/util/Map;Lcom/facebook/common/time/b;)V
...
.method constructor <init>(Ljava/lang/String;Ljava/util/Map;Lcom/facebook/common/time/b;)V
    .locals 1
    ...
    .line 5
    iput-object p3, p0, Lcom/facebook/imagepipeline/producers/x;->e:Lcom/facebook/common/time/b;
...
.method private g(Landroid/net/Uri;I)Ljava/net/HttpURLConnection;
    ...
    invoke-static {v6, v2}, Lutil/n7/j;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method static o(Landroid/net/Uri;)Ljava/net/HttpURLConnection;
    ...
    .line 1
    invoke-static {p0}, Lcom/facebook/common/util/e;->n(Landroid/net/Uri;)Ljava/net/URL;
...
.method public bridge synthetic a(Lcom/facebook/imagepipeline/producers/w;Lcom/facebook/imagepipeline/producers/k0$a;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/facebook/imagepipeline/producers/x;->i(Lcom/facebook/imagepipeline/producers/x$c;Lcom/facebook/imagepipeline/producers/k0$a;)V
...
.method public bridge synthetic e(Lcom/facebook/imagepipeline/producers/l;Lcom/facebook/imagepipeline/producers/p0;)Lcom/facebook/imagepipeline/producers/w;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lcom/facebook/imagepipeline/producers/x;->f(Lcom/facebook/imagepipeline/producers/l;Lcom/facebook/imagepipeline/producers/p0;)Lcom/facebook/imagepipeline/producers/x$c;
...
.method public f(Lcom/facebook/imagepipeline/producers/l;Lcom/facebook/imagepipeline/producers/p0;)Lcom/facebook/imagepipeline/producers/x$c;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2}, Lcom/facebook/imagepipeline/producers/x$c;-><init>(Lcom/facebook/imagepipeline/producers/l;Lcom/facebook/imagepipeline/producers/p0;)V

    return-object v0
.end method

.method public i(Lcom/facebook/imagepipeline/producers/x$c;Lcom/facebook/imagepipeline/producers/k0$a;)V
    .locals 2

    .line 1
    iget-object v0, p0, Lcom/facebook/imagepipeline/producers/x;->e:Lcom/facebook/common/time/b;

    invoke-interface {v0}, Lcom/facebook/common/time/b;->now()J

    move-result-wide v0

    invoke-static {p1, v0, v1}, Lcom/facebook/imagepipeline/producers/x$c;->l(Lcom/facebook/imagepipeline/producers/x$c;J)J
    ...
    invoke-direct {v1, p0, p1, p2}, Lcom/facebook/imagepipeline/producers/x$a;-><init>(Lcom/facebook/imagepipeline/producers/x;Lcom/facebook/imagepipeline/producers/x$c;Lcom/facebook/imagepipeline/producers/k0$a;)V
    ...
    invoke-direct {v1, p0, v0, p2}, Lcom/facebook/imagepipeline/producers/x$b;-><init>(Lcom/facebook/imagepipeline/producers/x;Ljava/util/concurrent/Future;Lcom/facebook/imagepipeline/producers/k0$a;)V

    .line 5
    invoke-interface {p1, v1}, Lcom/facebook/imagepipeline/producers/p0;->c(Lcom/facebook/imagepipeline/producers/q0;)V

    return-void
.end method

.method j(Lcom/facebook/imagepipeline/producers/x$c;Lcom/facebook/imagepipeline/producers/k0$a;)V
    .locals 4
    .annotation build Landroidx/annotation/VisibleForTesting;
    .end annotation
    ...
    .line 2
    :try_start_1
    iget-object v2, p0, Lcom/facebook/imagepipeline/producers/x;->e:Lcom/facebook/common/time/b;

    invoke-interface {v2}, Lcom/facebook/common/time/b;->now()J

    move-result-wide v2

    invoke-static {p1, v2, v3}, Lcom/facebook/imagepipeline/producers/x$c;->n(Lcom/facebook/imagepipeline/producers/x$c;J)J
    ...
    .line 4
    invoke-interface {p2, v0, p1}, Lcom/facebook/imagepipeline/producers/k0$a;->b(Ljava/io/InputStream;I)V
    :try_end_1
...
.method public k(Lcom/facebook/imagepipeline/producers/x$c;I)Ljava/util/Map;
    ...
    .line 3
    invoke-static {p1}, Lcom/facebook/imagepipeline/producers/x$c;->o(Lcom/facebook/imagepipeline/producers/x$c;)J
...
.method public n(Lcom/facebook/imagepipeline/producers/x$c;I)V
    ...
    .line 1
    iget-object p2, p0, Lcom/facebook/imagepipeline/producers/x;->e:Lcom/facebook/common/time/b;

    invoke-interface {p2}, Lcom/facebook/common/time/b;->now()J

    move-result-wide v0

    invoke-static {p1, v0, v1}, Lcom/facebook/imagepipeline/producers/x$c;->p(Lcom/facebook/imagepipeline/producers/x$c;J)J
