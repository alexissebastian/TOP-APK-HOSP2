...
.method private d(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    ...
    invoke-static {v1, v2, v3}, Lutil/o7/a;->g(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_4
    ...
    invoke-static {p3, p1}, Lcom/facebook/common/references/a;->i0(Ljava/lang/Object;Lcom/facebook/common/references/h;)Lcom/facebook/common/references/a;
    ...
    invoke-static {p1, p3}, Lcom/facebook/common/references/a;->i0(Ljava/lang/Object;Lcom/facebook/common/references/h;)Lcom/facebook/common/references/a;
...
.method private static f(Lutil/b9/d;Landroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;
    .locals 3
    ...
    .line 2
    invoke-virtual {p0}, Lutil/b9/d;->i0()I
...
# virtual methods
.method public a(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    .locals 8
    .param p3    # Landroid/graphics/Rect;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    .line 1
    invoke-virtual {p1, p4}, Lutil/b9/d;->m0(I)Z

    move-result v0

    .line 2
    invoke-static {p1, p2}, Lcom/facebook/imagepipeline/platform/b;->f(Lutil/b9/d;Landroid/graphics/Bitmap$Config;)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 6
    new-instance v2, Lutil/r7/a;

    invoke-direct {v2, v1, p4}, Lutil/r7/a;-><init>(Ljava/io/InputStream;I)V
    ...
    .line 7
    new-instance v0, Lutil/r7/b;

    sget-object v2, Lcom/facebook/imagepipeline/platform/b;->e:[B

    invoke-direct {v0, v1, v2}, Lutil/r7/b;-><init>(Ljava/io/InputStream;[B)V
    ...
    invoke-virtual/range {v2 .. v7}, Lcom/facebook/imagepipeline/platform/b;->a(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
...
.method public b(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
    .locals 2
    .param p3    # Landroid/graphics/Rect;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/facebook/imagepipeline/platform/b;->b(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;Landroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
...
.method public c(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;I)Lcom/facebook/common/references/a;
    .locals 6
    .param p3    # Landroid/graphics/Rect;
        .annotation runtime Ljavax/annotation/Nullable;
        .end annotation
    ...
    .line 1
    invoke-virtual/range {v0 .. v5}, Lcom/facebook/imagepipeline/platform/b;->a(Lutil/b9/d;Landroid/graphics/Bitmap$Config;Landroid/graphics/Rect;ILandroid/graphics/ColorSpace;)Lcom/facebook/common/references/a;
