...
# instance fields
.field private final c:Lutil/s7/b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lutil/s7/b;
...
.method private static i(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    invoke-virtual {p0}, Lcom/facebook/common/references/a;->c0()Ljava/lang/Object;
    ...
    .line 5
    :try_start_1
    new-instance v5, Lutil/r7/a;

    invoke-direct {v5, v4, p1}, Lutil/r7/a;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    .line 7
    invoke-static {v5, v3}, Lutil/n7/a;->a(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    ...
    .line 10
    invoke-static {v4}, Lutil/n7/b;->b(Ljava/io/InputStream;)V

    .line 11
    invoke-static {v5}, Lutil/n7/b;->b(Ljava/io/InputStream;)V

    .line 12
    invoke-static {v3, v1}, Lutil/n7/b;->a(Ljava/io/Closeable;Z)V
    ...
    .line 14
    invoke-static {v3}, Lutil/n7/b;->b(Ljava/io/InputStream;)V

    .line 15
    invoke-static {v5}, Lutil/n7/b;->b(Ljava/io/InputStream;)V

    .line 16
    invoke-static {p2, v1}, Lutil/n7/b;->a(Ljava/io/Closeable;Z)V
...
.method private j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 1
    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->i(Lcom/facebook/common/references/a;I[B)Landroid/os/MemoryFile;
    ...
    .line 3
    iget-object p3, p0, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->c:Lutil/s7/b;

    if-eqz p3, :cond_1

    .line 4
    invoke-interface {p3, p2, v0, p4}, Lutil/s7/b;->c(Ljava/io/FileDescriptor;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 5
    invoke-static {p2, p3}, Lutil/n7/k;->h(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lutil/n7/p;->a(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    :try_end_3
...
.method private declared-synchronized k()Ljava/lang/reflect/Method;
    ...
    .line 3
    :try_start_2
    invoke-static {v0}, Lutil/n7/p;->a(Ljava/lang/Throwable;)Ljava/lang/RuntimeException;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method protected d(Lcom/facebook/common/references/a;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method protected e(Lcom/facebook/common/references/a;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    .line 2
    :goto_0
    invoke-direct {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->j(Lcom/facebook/common/references/a;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
