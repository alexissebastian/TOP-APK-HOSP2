.class public final Lutil/i2/p;
.super Ljava/lang/Object;
.source "SourceFile"

# interfaces
.implements Lcom/adobe/xmp/e;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lutil/i2/p;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lutil/i2/p;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lutil/i2/p;->c:Ljava/util/Map;
    ...
    iput-object v0, p0, Lutil/i2/p;->d:Ljava/util/regex/Pattern;

    :try_start_0
    invoke-direct {p0}, Lutil/i2/p;->g()V

    invoke-direct {p0}, Lutil/i2/p;->f()V
    :try_end_0
...
.method private f()V
    ...
    new-instance v6, Lutil/k2/a;

    invoke-direct {v6}, Lutil/k2/a;-><init>()V

    const/4 v0, 0x1

    invoke-virtual {v6, v0}, Lutil/k2/a;->l(Z)Lutil/k2/a;

    new-instance v13, Lutil/k2/a;

    invoke-direct {v13}, Lutil/k2/a;-><init>()V

    invoke-virtual {v13, v0}, Lutil/k2/a;->k(Z)Lutil/k2/a;
    ...
    invoke-virtual/range {v0 .. v5}, Lutil/i2/p;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lutil/k2/a;)V
    ...
    invoke-virtual/range {v7 .. v12}, Lutil/i2/p;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lutil/k2/a;)V
    ...
    invoke-virtual/range {v6 .. v11}, Lutil/i2/p;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lutil/k2/a;)V
...
.method private g()V
    ...
    invoke-virtual {p0, v0, v1}, Lutil/i2/p;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public declared-synchronized a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lutil/i2/p;->a:Ljava/util/Map;
...
.method public declared-synchronized b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lutil/i2/e;->c(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lutil/i2/h;->g(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Lutil/i2/p;->b:Ljava/util/Map;
    ...
    :goto_0
    :try_start_1
    iget-object v4, p0, Lutil/i2/p;->b:Ljava/util/Map;
    ...
    :cond_3
    iget-object v0, p0, Lutil/i2/p;->b:Ljava/util/Map;
...
.method public declared-synchronized d(Ljava/lang/String;)Lutil/l2/a;
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lutil/i2/p;->c:Ljava/util/Map;

    invoke-interface {v0, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lutil/l2/a;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method declared-synchronized e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lutil/k2/a;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/adobe/xmp/XMPException;
    ...
    invoke-static {p2}, Lutil/i2/e;->d(Ljava/lang/String;)V

    invoke-static {p3}, Lutil/i2/e;->e(Ljava/lang/String;)V

    invoke-static {p4}, Lutil/i2/e;->d(Ljava/lang/String;)V

    if-eqz p5, :cond_0

    new-instance v0, Lutil/k2/a;

    invoke-virtual {p5}, Lutil/k2/a;->m()Lutil/k2/e;

    move-result-object p5

    const/4 v1, 0x0

    invoke-static {p5, v1}, Lutil/i2/n;->p(Lutil/k2/e;Ljava/lang/Object;)Lutil/k2/e;

    move-result-object p5

    invoke-virtual {p5}, Lutil/k2/c;->d()I

    move-result p5

    invoke-direct {v0, p5}, Lutil/k2/a;-><init>(I)V
    ...
    invoke-direct {v0}, Lutil/k2/a;-><init>()V

    :goto_0
    move-object v6, v0

    iget-object p5, p0, Lutil/i2/p;->d:Ljava/util/regex/Pattern;
    ...
    invoke-virtual {p0, p1}, Lutil/i2/p;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p3}, Lutil/i2/p;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p2, p0, Lutil/i2/p;->c:Ljava/util/Map;
    ...
    invoke-direct/range {v1 .. v6}, Lutil/i2/p$a;-><init>(Lutil/i2/p;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lutil/k2/a;)V

    iget-object p3, p0, Lutil/i2/p;->c:Ljava/util/Map;
