...
.method public bridge synthetic a(Lorg/json/JSONObject;)Lutil/k3/b;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lutil/w3/h$a;->c(Lorg/json/JSONObject;)Lutil/w3/h;
...
.method public bridge synthetic b(Lutil/k3/b;)Lorg/json/JSONObject;
    ...
    invoke-virtual {p0, p1}, Lutil/w3/h$a;->d(Lutil/w3/h;)Lorg/json/JSONObject;
...
.method public c(Lorg/json/JSONObject;)Lutil/w3/h;
    .locals 3
    .param p1    # Lorg/json/JSONObject;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 1
    new-instance v0, Lutil/w3/h;

    invoke-direct {v0}, Lutil/w3/h;-><init>()V
    ...
    invoke-static {v2}, Lutil/k3/a;->a(Lorg/json/JSONArray;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {v0, v2}, Lutil/w3/h;->c(Ljava/util/List;)V
    ...
    invoke-virtual {v0, p1}, Lutil/w3/h;->d(Z)V

    return-object v0
.end method

.method public d(Lutil/w3/h;)Lorg/json/JSONObject;
    .locals 3
    .param p1    # Lutil/w3/h;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 2
    :try_start_0
    invoke-virtual {p1}, Lutil/w3/h;->a()Ljava/util/List;
    ...
    .line 3
    invoke-virtual {p1}, Lutil/w3/h;->b()Z
