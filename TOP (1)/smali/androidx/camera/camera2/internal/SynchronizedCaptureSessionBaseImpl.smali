...
.method private synthetic c(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    .locals 1
...
.method private synthetic i(Ljava/util/List;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method public synthetic b()V
    ...
    invoke-direct {p0}, Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;->a()V
...
.method public close()V
    ...
    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/o1;-><init>(Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;)V
...
.method public synthetic d(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;->c(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V

    return-void
.end method

.method public synthetic f(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    .locals 0
...
.method public synthetic h(Ljava/util/List;Landroidx/camera/camera2/internal/compat/CameraDeviceCompat;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public synthetic j(Ljava/util/List;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;->i(Ljava/util/List;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
...
.method public onClosed(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    invoke-direct {v0, p0, p1}, Landroidx/camera/camera2/internal/m1;-><init>(Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
...
.method onSessionFinished(Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
    ...
    invoke-direct {v0, p0, p1}, Landroidx/camera/camera2/internal/k1;-><init>(Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;Landroidx/camera/camera2/internal/SynchronizedCaptureSession;)V
...
.method public openCaptureSession(Landroid/hardware/camera2/CameraDevice;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;Ljava/util/List;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {v1, p0, p3, p1, p2}, Landroidx/camera/camera2/internal/l1;-><init>(Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;Ljava/util/List;Landroidx/camera/camera2/internal/compat/CameraDeviceCompat;Landroidx/camera/camera2/internal/compat/params/SessionConfigurationCompat;)V
...
.method public startWithDeferrableSurface(Ljava/util/List;J)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    new-instance p3, Landroidx/camera/camera2/internal/n1;

    invoke-direct {p3, p0, p1}, Landroidx/camera/camera2/internal/n1;-><init>(Landroidx/camera/camera2/internal/SynchronizedCaptureSessionBaseImpl;Ljava/util/List;)V
